{{hh, -1/2*(A0[Mass2[Ah]]*Cp[hh, Ah, Ah]) - (A0[Mass2[hh]]*Cp[hh, hh, hh])/
    2 - (A0[Mass2[ss]]*Cp[hh, ss, ss])/2 + 
   A0[Mass2[gWp]]*Cp[hh, bar[gWp], gWp] + A0[Mass2[gWpC]]*
    Cp[hh, bar[gWpC], gWpC] + A0[Mass2[gZ]]*Cp[hh, bar[gZ], gZ] - 
   A0[Mass2[Hp]]*Cp[hh, conj[Hp], Hp] + 4*Cp[hh, conj[VWp], VWp]*
    (A0[Mass2[VWp]] - (rMS*Mass2[VWp])/2) + 2*Cp[hh, VZ, VZ]*
