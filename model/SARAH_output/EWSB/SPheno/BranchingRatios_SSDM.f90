...
& gTFd(3),BRFd(3,150),gPhh(1,49),gThh,BRhh(1,49)
...
& MFe,MFe2,MHp,MHp2,Mss,Mss2,MAh,MAh2,Mhh,Mhh2,MVZ,MVZ2,MVWp,MVWp2,ZDL,ZDR,              & 
& ZUL,ZUR,ZEL,ZER,v,g1,g2,g3,LS,LSH,Lam,Yu,Yd,Ye,MS2,mu2,epsI,deltaM,kont)
...
& g2,g3,LS,LSH,Lam,Yu,Yd,Ye,MS2,mu2,v,gPFu(:,1:15),gTFu,BRFu(:,1:15))
...
& MHp,MHp2,Mss,Mss2,MVWp,MVWp2,MVZ,MVZ2,TW,ZDR,ZER,ZUR,ZDL,ZEL,ZUL,ZW,ZZ,g1,             & 
& g2,g3,LS,LSH,Lam,Yu,Yd,Ye,MS2,mu2,v,gPFe(:,1:12),gTFe,BRFe(:,1:12))
...
& MHp,MHp2,Mss,Mss2,MVWp,MVWp2,MVZ,MVZ2,TW,ZDR,ZER,ZUR,ZDL,ZEL,ZUL,ZW,ZZ,g1,             & 
& g2,g3,LS,LSH,Lam,Yu,Yd,Ye,MS2,mu2,v,gPFd(:,1:15),gTFd,BRFd(:,1:15))
...
& MHp,MHp2,Mss,Mss2,MVWp,MVWp2,MVZ,MVZ2,TW,ZDR,ZER,ZUR,ZDL,ZEL,ZUL,ZW,ZZ,g1,             & 
& g2,g3,LS,LSH,Lam,Yu,Yd,Ye,MS2,mu2,v,gPhh,gThh,BRhh)
...
& g3,LS,LSH,Lam,Yu,Yd,Ye,MS2,mu2,v,gThh,gTVWp,gTVZ,gFuFucFdFd,gFuFdcFeFv,gFuFucFeFe,     & 
& gFuFucFuFu,gFuFucFvFv,epsI,deltaM,.False.,gTFu,gPFu(:,16:150),BRFu(:,16:150))

Else 
Call FuThreeBodyDecay(-1,MAh,MAh2,MFd,MFd2,MFe,MFe2,MFu,MFu2,Mhh,Mhh2,MHp,            & 
& MHp2,Mss,Mss2,MVWp,MVWp2,MVZ,MVZ2,TW,ZDR,ZER,ZUR,ZDL,ZEL,ZUL,ZW,ZZ,g1,g2,              & 
& g3,LS,LSH,Lam,Yu,Yd,Ye,MS2,mu2,v,gThh,gTVWp,gTVZ,gFuFucFdFd,gFuFdcFeFv,gFuFucFeFe,     & 
& gFuFucFuFu,gFuFucFvFv,epsI,deltaM,.True.,gTFu,gPFu(:,16:150),BRFu(:,16:150))
...
& gFeFecFvFv,gFeFvcFuFd,epsI,deltaM,.False.,gTFe,gPFe(:,13:147),BRFe(:,13:147))

Else 
Call FeThreeBodyDecay(-1,MAh,MAh2,MFd,MFd2,MFe,MFe2,MFu,MFu2,Mhh,Mhh2,MHp,            & 
& MHp2,Mss,Mss2,MVWp,MVWp2,MVZ,MVZ2,TW,ZDR,ZER,ZUR,ZDL,ZEL,ZUL,ZW,ZZ,g1,g2,              & 
& g3,LS,LSH,Lam,Yu,Yd,Ye,MS2,mu2,v,gThh,gTVWp,gTVZ,gFeFecFdFd,gFeFecFeFe,gFeFecFuFu,     & 
& gFeFecFvFv,gFeFvcFuFd,epsI,deltaM,.True.,gTFe,gPFe(:,13:147),BRFe(:,13:147))
...
& MHp2,Mss,Mss2,MVWp,MVWp2,MVZ,MVZ2,TW,ZDR,ZER,ZUR,ZDL,ZEL,ZUL,ZW,ZZ,g1,g2,              & 
& g3,LS,LSH,Lam,Yu,Yd,Ye,MS2,mu2,v,gThh,gTVWp,gTVZ,gFdFdcFdFd,gFdFdcFeFe,gFdFdcFuFu,     & 
& gFdFdcFvFv,gFdFucFvFe,epsI,deltaM,.False.,gTFd,gPFd(:,16:150),BRFd(:,16:150))

Else 
Call FdThreeBodyDecay(-1,MAh,MAh2,MFd,MFd2,MFe,MFe2,MFu,MFu2,Mhh,Mhh2,MHp,            & 
& MHp2,Mss,Mss2,MVWp,MVWp2,MVZ,MVZ2,TW,ZDR,ZER,ZUR,ZDL,ZEL,ZUL,ZW,ZZ,g1,g2,              & 
& g3,LS,LSH,Lam,Yu,Yd,Ye,MS2,mu2,v,gThh,gTVWp,gTVZ,gFdFdcFdFd,gFdFdcFeFe,gFdFdcFuFu,     & 
& gFdFdcFvFv,gFdFucFvFe,epsI,deltaM,.True.,gTFd,gPFd(:,16:150),BRFd(:,16:150))
...
End Module BranchingRatios_SSDM 
