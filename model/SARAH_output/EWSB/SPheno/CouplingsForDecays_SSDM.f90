...
Module CouplingsForDecays_SSDM
...
& ZDRinput,ZERinput,ZURinput,ZDLinput,ZELinput,ZULinput,ZWinput,ZZinput,g1input,         & 
& g2input,g3input,LSinput,LSHinput,Laminput,Yuinput,Ydinput,Yeinput,MS2input,            & 
& mu2input,vinput,cplcFuFdVWpL,cplcFuFdVWpR,cplcFuFuhhL,cplcFuFuhhR,cplcFuFuVZL,         & 
& cplcFuFuVZR,deltaM)
...
& ZDRinput,ZERinput,ZURinput,ZDLinput,ZELinput,ZULinput,ZWinput,ZZinput,g1input,         & 
& g2input,g3input,LSinput,LSHinput,Laminput,Yuinput,Ydinput,Yeinput,MS2input,            & 
& mu2input,vinput,cplcFeFehhL,cplcFeFehhR,cplcFeFeVZL,cplcFeFeVZR,cplcFeFvcVWpL,         & 
...
& ZDRinput,ZERinput,ZURinput,ZDLinput,ZELinput,ZULinput,ZWinput,ZZinput,g1input,         & 
& g2input,g3input,LSinput,LSHinput,Laminput,Yuinput,Ydinput,Yeinput,MS2input,            & 
& mu2input,vinput,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVZL,cplcFdFdVZR,cplcFdFucVWpL,         & 
...
& ZDRinput,ZERinput,ZURinput,ZDLinput,ZELinput,ZULinput,ZWinput,ZZinput,g1input,         & 
& g2input,g3input,LSinput,LSHinput,Laminput,Yuinput,Ydinput,Yeinput,MS2input,            & 
& mu2input,vinput,cplHiggsPP,cplHiggsGG,cplHiggsZZvirt,cplHiggsWWvirt,cplcFdFdhhL,       & 
& cplcFdFdhhR,cplcFeFehhL,cplcFeFehhR,cplcFuFuhhL,cplcFuFuhhR,cplhhhhhh,cplhhssss,       & 
& cplhhcVWpVWp,cplhhVZVZ,deltaM)
...
& ZDRinput,ZERinput,ZURinput,ZDLinput,ZELinput,ZULinput,ZWinput,ZZinput,g1input,         & 
& g2input,g3input,LSinput,LSHinput,Laminput,Yuinput,Ydinput,Yeinput,MS2input,            & 
& mu2input,vinput,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVZL,cplcFdFdVZR,cplcFeFehhL,           & 
...
& g2input,g3input,LSinput,LSHinput,Laminput,Yuinput,Ydinput,Yeinput,MS2input,            & 
& mu2input,vinput,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVZL,cplcFdFdVZR,cplcFdFucVWpL,         & 
& cplcFdFucVWpR,cplcFeFehhL,cplcFeFehhR,cplcFeFeVZL,cplcFeFeVZR,cplcFuFdVWpL,            & 
& cplcFuFdVWpR,cplcFuFuhhL,cplcFuFuhhR,cplcFuFuVZL,cplcFuFuVZR,cplcFvFeVWpL,             & 
& cplcFvFeVWpR,cplcFvFvVZL,cplcFvFvVZR,deltaM)
...
End Module CouplingsForDecays_SSDM
