...
res = 0._dp 
res = res-1._dp/2._dp*(g1*g2*v*Sin(TW))
If (Real(res,dp).ne.Real(res,dp)) Then 
 Write(*,*) "NaN appearing in ",NameOfUnit(Iname) 
 Call TerminateProgram 
End If 
...
res = 0._dp 
res = res-1._dp/4._dp*(g2**2*v*RXiWp)
res = -(0.,1.)*res 
...
res = res-1._dp/8._dp*(g2**2*v*RXiZ*Sin(2._dp*(TW)))
If (Real(res,dp).ne.Real(res,dp)) Then 
 Write(*,*) "NaN appearing in ",NameOfUnit(Iname) 
 Call TerminateProgram 
End If 
...
res = 0._dp 
res = res-1._dp/4._dp*(g1*g2*v*Cos(TW)*RXiWp)
res = res-1._dp/4._dp*(g2**2*v*RXiWp*Sin(TW))
If (Real(res,dp).ne.Real(res,dp)) Then 
 Write(*,*) "NaN appearing in ",NameOfUnit(Iname) 
 Call TerminateProgram 
End If 
...
res = 0._dp 
res = res-1._dp/4._dp*(g2**2*v*Cos(TW)**2*RXiZ)
res = res-1._dp/2._dp*(g1*g2*v*Cos(TW)*RXiZ*Sin(TW))
res = res-1._dp/4._dp*(g1**2*v*RXiZ*Sin(TW)**2)
If (Real(res,dp).ne.Real(res,dp)) Then 
 Write(*,*) "NaN appearing in ",NameOfUnit(Iname) 
 Call TerminateProgram 
End If 
...
res = 0._dp 
res = res-1._dp/4._dp*(g2**2*v*Cos(TW)*RXiWp)
...
Subroutine CouplingsFor2LPole3(Lam,v,LSH,g3,Yd,ZDL,ZDR,Ye,ZEL,ZER,Yu,ZUL,             & 
& ZUR,cplAhAhhh,cplhhhhhh,cplhhHpcHp,cplhhssss,cplVGVGVG,cplcFdFdAhL,cplcFdFdAhR,        & 
& cplcFeFeAhL,cplcFeFeAhR,cplcFuFuAhL,cplcFuFuAhR,cplcFdFdhhL,cplcFdFdhhR,               & 
& cplcFuFdHpL,cplcFuFdHpR,cplcFeFehhL,cplcFeFehhR,cplcFvFeHpL,cplcFvFeHpR,               & 
& cplcFuFuhhL,cplcFuFuhhR,cplcFdFucHpL,cplcFdFucHpR,cplcFeFvcHpL,cplcFeFvcHpR,           & 
...
cplAhAhhh = 0._dp 
Call CouplingAhAhhh2LP(Lam,v,cplAhAhhh)



cplhhhhhh = 0._dp 
Call Couplinghhhhhh2LP(Lam,v,cplhhhhhh)



cplhhHpcHp = 0._dp 
Call CouplinghhHpcHp2LP(Lam,v,cplhhHpcHp)



cplhhssss = 0._dp 
Call Couplinghhssss2LP(LSH,v,cplhhssss)
...
Subroutine CouplingAhAhhh2LP(Lam,v,res)
...
Subroutine Couplinghhhhhh2LP(Lam,v,res)
...
Subroutine CouplinghhHpcHp2LP(Lam,v,res)
...
Subroutine Couplinghhssss2LP(LSH,v,res)
...
End Subroutine Couplinghhssss2LP  
...
Subroutine CouplingsFor2LPole4(Lam,LSH,LS,cplAhAhAhAh,cplAhAhhhhh,cplAhAhHpcHp,       & 
& cplAhAhssss,cplhhhhhhhh,cplhhhhHpcHp,cplhhhhssss,cplHpHpcHpcHp,cplHpsssscHp,           & 
& cplssssssss)
...
cplAhAhssss = 0._dp 
Call CouplingAhAhssss2LP(LSH,cplAhAhssss)
...
cplhhhhssss = 0._dp 
Call Couplinghhhhssss2LP(LSH,cplhhhhssss)
...
cplHpsssscHp = 0._dp 
Call CouplingHpsssscHp2LP(LSH,cplHpsssscHp)



cplssssssss = 0._dp 
Call Couplingssssssss2LP(LS,cplssssssss)
...
Subroutine CouplingAhAhssss2LP(LSH,res)
...
End Subroutine CouplingAhAhssss2LP  
...
Subroutine Couplinghhhhssss2LP(LSH,res)
...
End Subroutine Couplinghhhhssss2LP  
...
Subroutine CouplingHpsssscHp2LP(LSH,res)
...
End Subroutine CouplingHpsssscHp2LP  
 
 
Subroutine Couplingssssssss2LP(LS,res)
...
End Subroutine Couplingssssssss2LP  
...
& cplAhcHpVWp,cplcFdFucHpL,cplcFdFucHpR,cplcFeFvcHpL,cplcFeFvcHpR,cplcgZgWpcHp,          & 
& cplcgWpgZHp,cplcgWCgZcHp,cplcgZgWCHp,cplhhHpcHp,cplhhcHpVWp,cplHpcHpVP,cplHpcHpVZ,     & 
& cplcHpVPVWp,cplcHpVWpVZ,cplAhAhHpcHp,cplhhhhHpcHp,cplHpHpcHpcHp,cplHpsssscHp,          & 
& cplHpcHpVPVP,cplHpcHpcVWpVWp,cplHpcHpVZVZ,cplhhssss,cplAhAhssss,cplhhhhssss,           & 
& cplssssssss,cplAhAhhh,cplcFdFdAhL,cplcFdFdAhR,cplcFeFeAhL,cplcFeFeAhR,cplcFuFuAhL,     & 
...
& cplHpcHpVZVZ,cplhhssss,cplAhAhssss,cplhhhhssss,cplssssssss,cplAhAhhh,cplcFdFdAhL(3,3), & 
...
& cplAhAhcVWpVWp,cplAhAhVZVZ,cplcFdFdhhL(3,3),cplcFdFdhhR(3,3),cplcFeFehhL(3,3),         & 
...
& cplhhhhVZVZ,cplcFdFdVGL(3,3),cplcFdFdVGR(3,3),cplcFuFuVGL(3,3),cplcFuFuVGR(3,3),       & 
...
Subroutine CouplingsForVectorBosons(g2,g1,TW,v,ZDL,ZUL,ZEL,cplAhcHpVWp,               & 
...
Subroutine CouplingsColoredQuartics(Lam,LSH,LS,g2,g1,TW,g3,cplAhAhAhAh1,              & 
& cplAhAhhhhh1,cplAhAhHpcHp1,cplAhAhssss1,cplhhhhhhhh1,cplhhhhHpcHp1,cplhhhhssss1,       & 
& cplHpHpcHpcHp1,cplHpsssscHp1,cplssssssss1,cplAhAhcVWpVWp1,cplAhAhVZVZ1,cplAhHpcVWpVP1, & 
& cplAhHpcVWpVZ1,cplAhcHpVPVWp1,cplAhcHpVWpVZ1,cplhhhhcVWpVWp1,cplhhhhVZVZ1,             & 
...
Complex(dp), Intent(out) :: cplAhAhAhAh1,cplAhAhhhhh1,cplAhAhHpcHp1,cplAhAhssss1,cplhhhhhhhh1,cplhhhhHpcHp1,      & 
...
cplAhAhssss1 = 0._dp 
Call CouplingAhAhssssQ(LSH,cplAhAhssss1)
...
cplhhhhssss1 = 0._dp 
Call CouplinghhhhssssQ(LSH,cplhhhhssss1)
...
cplHpsssscHp1 = 0._dp 
Call CouplingHpsssscHpQ(LSH,cplHpsssscHp1)



cplssssssss1 = 0._dp 
Call CouplingssssssssQ(LS,cplssssssss1)
...
Subroutine CouplingAhAhssssQ(LSH,res1)
...
End Subroutine CouplingAhAhssssQ  
...
Subroutine CouplinghhhhssssQ(LSH,res1)
...
End Subroutine CouplinghhhhssssQ  
...
Subroutine CouplingHpsssscHpQ(LSH,res1)
...
End Subroutine CouplingHpsssscHpQ  
 
 
Subroutine CouplingssssssssQ(LS,res1)
...
End Subroutine CouplingssssssssQ  
...
Subroutine CouplingsColourStructures(Lam,v,LSH,LS,cplAhAhhh,cplhhhhhh,cplhhHpcHp,     & 
...
cplAhAhhh = 0._dp 
Call CouplingAhAhhhCS(Lam,v,cplAhAhhh)



cplhhhhhh = 0._dp 
Call CouplinghhhhhhCS(Lam,v,cplhhhhhh)



cplhhHpcHp = 0._dp 
Call CouplinghhHpcHpCS(Lam,v,cplhhHpcHp)



cplhhssss = 0._dp 
Call CouplinghhssssCS(LSH,v,cplhhssss)
...
cplAhAhssss = 0._dp 
Call CouplingAhAhssssCS(LSH,cplAhAhssss)
...
cplhhhhssss = 0._dp 
Call CouplinghhhhssssCS(LSH,cplhhhhssss)
...
cplHpsssscHp = 0._dp 
Call CouplingHpsssscHpCS(LSH,cplHpsssscHp)



cplssssssss = 0._dp 
Call CouplingssssssssCS(LS,cplssssssss)
...
Subroutine CouplingAhAhhhCS(Lam,v,res1)
...
Subroutine CouplinghhhhhhCS(Lam,v,res1)
...
Subroutine CouplinghhHpcHpCS(Lam,v,res1)
...
Subroutine CouplinghhssssCS(LSH,v,res1)
...
End Subroutine CouplinghhssssCS  
...
Subroutine CouplingAhAhssssCS(LSH,res1)
...
End Subroutine CouplingAhAhssssCS  
...
Subroutine CouplinghhhhssssCS(LSH,res1)
...
End Subroutine CouplinghhhhssssCS  
...
Subroutine CouplingHpsssscHpCS(LSH,res1)
...
End Subroutine CouplingHpsssscHpCS  
 
 
Subroutine CouplingssssssssCS(LS,res1)
...
End Subroutine CouplingssssssssCS  
 
 
End Module Couplings_SSDM 
