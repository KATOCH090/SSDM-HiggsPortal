...
& PDGgG,PDGFd(3),PDGFu(3),PDGFe(3),PDGFv(3)
...
l_open= .False.
End If
Write(io_L,100) "# SUSY Les Houches Accord 2 - SSDM Spectrum + Decays + Flavour Observables"
...
Write(io_L,100) "Block DMASS  # Overall uncertainty"
 Write(io_L,102) INT(Abs(6666635)), Sqrt(mass_uncertainty_Q(2)**2+mass_uncertainty_Yt(2)**2),"# Mss(1) " 
 Write(io_L,102) INT(Abs(25)), Sqrt(mass_uncertainty_Q(4)**2+mass_uncertainty_Yt(4)**2),"# Mhh(1) " 
Write(io_L,100) "Block DMASSQ  # Scale uncertainty"
 Write(io_L,102) INT(Abs(6666635)), mass_uncertainty_Q(2),"# Mss(1) " 
 Write(io_L,102) INT(Abs(25)), mass_uncertainty_Q(4),"# Mhh(1) " 
Write(io_L,100) "Block DMASST  # Top Matching uncertainty"
 Write(io_L,102) INT(Abs(6666635)), mass_uncertainty_Yt(2),"# Mss(1) " 
 Write(io_L,102) INT(Abs(25)), mass_uncertainty_Yt(4),"# Mhh(1) " 
End if
...
Write(io_L,200) INT(Abs(PDGss)),0._dp, "ss_1" 
...
Subroutine WriteWHIZARD 
   Open(123,file="WHIZARD.par.SSDM",status="unknown")
...
Subroutine WriteWCXF 
   Open(123,file="WC.SSDM_1.json",status="unknown")
Write(123,*) "{"
Write(123,*) '  "eft": "WET",'
...
Write(123,*) "}"
    Close(123) 
   Open(123,file="WC.SSDM_2.json",status="unknown")
Write(123,*) "{"
Write(123,*) '  "eft": "WET",'
Write(123,*) '  "basis": "FlavorKit",'
Write(123,*) '  "scale": "91.",'
