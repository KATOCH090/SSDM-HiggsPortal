...
Module Wrapper_OneLoopDecay_Fd_SSDM
Use Model_Data_SSDM 
Use Kinematics 
Use OneLoopDecay_Fd_SSDM 
Use Control 
Use Settings 
...
& ZfVPVZ,ZfVZVP,cplAhAhhh,cplAhcHpVWp,cplAhhhVZ,cplAhHpcVWp,cplcFdFdAhL,cplcFdFdAhR,     & 
...
Call Amplitude_Tree_SSDM_FdToFdhh(cplcFdFdhhL,cplcFdFdhhR,MFd,Mhh,MFd2,               & 
& Mhh2,AmpTreeFdToFdhh)

  Else 
Call Amplitude_Tree_SSDM_FdToFdhh(ZcplcFdFdhhL,ZcplcFdFdhhR,MFd,Mhh,MFd2,             & 
& Mhh2,AmpTreeFdToFdhh)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_SSDM_FdToFdhh(MLambda,em,gs,cplcFdFdhhL,cplcFdFdhhR,MFdOS,            & 
& MhhOS,MRPFdToFdhh,MRGFdToFdhh)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_SSDM_FdToFdhh(MLambda,em,gs,ZcplcFdFdhhL,ZcplcFdFdhhR,MFdOS,          & 
& MhhOS,MRPFdToFdhh,MRGFdToFdhh)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_SSDM_FdToFdhh(MLambda,em,gs,cplcFdFdhhL,cplcFdFdhhR,MFd,              & 
& Mhh,MRPFdToFdhh,MRGFdToFdhh)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_SSDM_FdToFdhh(MLambda,em,gs,ZcplcFdFdhhL,ZcplcFdFdhhR,MFd,            & 
& Mhh,MRPFdToFdhh,MRGFdToFdhh)
...
Call Amplitude_WAVE_SSDM_FdToFdhh(cplcFdFdhhL,cplcFdFdhhR,ctcplcFdFdhhL,              & 
& ctcplcFdFdhhR,MFd,MFd2,Mhh,Mhh2,ZfDL,ZfDR,Zfhh,AmpWaveFdToFdhh)



!Vertex Corrections 
Call Amplitude_VERTEX_SSDM_FdToFdhh(MAh,MFd,MFu,Mhh,MHp,MVG,MVP,MVWp,MVZ,             & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_SSDM_FdToFdhh(MAh,MFd,MFu,Mhh,MHp,MVG,MVP,MVWp,              & 
...
& cplhhVZVZ,AmpVertexIRdrFdToFdhh)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_SSDM_FdToFdhh(MAhOS,MFdOS,MFuOS,MhhOS,MHpOS,MVG,             & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_SSDM_FdToFdVZ(cplcFdFdVZL,cplcFdFdVZR,MFd,MVZ,MFd2,               & 
& MVZ2,AmpTreeFdToFdVZ)

  Else 
Call Amplitude_Tree_SSDM_FdToFdVZ(ZcplcFdFdVZL,ZcplcFdFdVZR,MFd,MVZ,MFd2,             & 
& MVZ2,AmpTreeFdToFdVZ)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_SSDM_FdToFdVZ(MLambda,em,gs,cplcFdFdVZL,cplcFdFdVZR,MFdOS,            & 
& MVZOS,MRPFdToFdVZ,MRGFdToFdVZ)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_SSDM_FdToFdVZ(MLambda,em,gs,ZcplcFdFdVZL,ZcplcFdFdVZR,MFdOS,          & 
& MVZOS,MRPFdToFdVZ,MRGFdToFdVZ)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_SSDM_FdToFdVZ(MLambda,em,gs,cplcFdFdVZL,cplcFdFdVZR,MFd,              & 
& MVZ,MRPFdToFdVZ,MRGFdToFdVZ)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_SSDM_FdToFdVZ(MLambda,em,gs,ZcplcFdFdVZL,ZcplcFdFdVZR,MFd,            & 
& MVZ,MRPFdToFdVZ,MRGFdToFdVZ)
...
!Self-energy Corrections 
Call Amplitude_WAVE_SSDM_FdToFdVZ(cplcFdFdVPL,cplcFdFdVPR,cplcFdFdVZL,cplcFdFdVZR,    & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_SSDM_FdToFdVZ(MAh,MFd,MFu,Mhh,MHp,MVG,MVP,MVWp,MVZ,             & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_SSDM_FdToFdVZ(MAh,MFd,MFu,Mhh,MHp,MVG,MVP,MVWp,              & 
...
& cplhhVZVZ,cplHpcHpVZ,cplHpcVWpVZ,cplcHpVWpVZ,cplcVWpVWpVZ,AmpVertexIRdrFdToFdVZ)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_SSDM_FdToFdVZ(MAhOS,MFdOS,MFuOS,MhhOS,MHpOS,MVG,             & 
& MVP,MVWpOS,MVZOS,MAh2OS,MFd2OS,MFu2OS,Mhh2OS,MHp2OS,MVG2,MVP2,MVWp2OS,MVZ2OS,          & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_SSDM_FdToFucVWp(cplcFdFucVWpL,cplcFdFucVWpR,MFd,MFu,              & 
& MVWp,MFd2,MFu2,MVWp2,AmpTreeFdToFucVWp)

  Else 
Call Amplitude_Tree_SSDM_FdToFucVWp(ZcplcFdFucVWpL,ZcplcFdFucVWpR,MFd,MFu,            & 
& MVWp,MFd2,MFu2,MVWp2,AmpTreeFdToFucVWp)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_SSDM_FdToFucVWp(MLambda,em,gs,cplcFdFucVWpL,cplcFdFucVWpR,            & 
& MFdOS,MFuOS,MVWpOS,MRPFdToFucVWp,MRGFdToFucVWp)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_SSDM_FdToFucVWp(MLambda,em,gs,ZcplcFdFucVWpL,ZcplcFdFucVWpR,          & 
& MFdOS,MFuOS,MVWpOS,MRPFdToFucVWp,MRGFdToFucVWp)
...
!Self-energy Corrections 
Call Amplitude_WAVE_SSDM_FdToFucVWp(cplcFdFucVWpL,cplcFdFucVWpR,ctcplcFdFucVWpL,      & 
& ctcplcFdFucVWpR,MFd,MFd2,MFu,MFu2,MVWp,MVWp2,ZfDL,ZfDR,ZfUL,ZfUR,ZfVWp,AmpWaveFdToFucVWp)



!Vertex Corrections 
Call Amplitude_VERTEX_SSDM_FdToFucVWp(MAh,MFd,MFu,Mhh,MHp,MVG,MVP,MVWp,               & 
& MVZ,MAh2,MFd2,MFu2,Mhh2,MHp2,MVG2,MVP2,MVWp2,MVZ2,cplcFdFdAhL,cplcFdFdAhR,             & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_SSDM_FdToFucVWp(MAh,MFd,MFu,Mhh,MHp,MVG,MVP,MVWp,            & 
& MVZ,MAh2,MFd2,MFu2,Mhh2,MHp2,MVG2,MVP2,MVWp2,MVZ2,cplcFdFdAhL,cplcFdFdAhR,             & 
& cplcFuFuAhL,cplcFuFuAhR,cplAhHpcVWp,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVGL,               & 
& cplcFdFdVGR,cplcFdFdVPL,cplcFdFdVPR,cplcFdFdVZL,cplcFdFdVZR,cplcFuFuhhL,               & 
& cplcFuFuhhR,cplcFuFuVGL,cplcFuFuVGR,cplcFuFuVPL,cplcFuFuVPR,cplcFuFuVZL,               & 
...
& cplhhcVWpVWp,cplHpcVWpVP,cplHpcVWpVZ,cplcVWpVPVWp,cplcVWpVWpVZ,AmpVertexIRdrFdToFucVWp)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_SSDM_FdToFucVWp(MAhOS,MFdOS,MFuOS,MhhOS,MHpOS,               & 
...
!Self-energy Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_WAVE_SSDM_FdToFdVG(ZcplcFdFdVGL,ZcplcFdFdVGR,ctcplcFdFdVGL,            & 
& ctcplcFdFdVGR,MFdOS,MFd2OS,MVG,MVG2,ZfDL,ZfDR,ZfVG,AmpWaveFdToFdVG)

 Else 
Call Amplitude_WAVE_SSDM_FdToFdVG(cplcFdFdVGL,cplcFdFdVGR,ctcplcFdFdVGL,              & 
& ctcplcFdFdVGR,MFdOS,MFd2OS,MVG,MVG2,ZfDL,ZfDR,ZfVG,AmpWaveFdToFdVG)
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_SSDM_FdToFdVG(MAhOS,MFdOS,MFuOS,MhhOS,MHpOS,MVG,MVP,            & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_SSDM_FdToFdVG(MAh,MFd,MFu,Mhh,MHp,MVG,MVP,MVWp,MVZ,             & 
...
!Self-energy Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_WAVE_SSDM_FdToFdVP(ZcplcFdFdVPL,ZcplcFdFdVPR,ZcplcFdFdVZL,             & 
...
& MFd2OS,MVP,MVP2,ZfDL,ZfDR,ZfVP,ZfVZVP,AmpWaveFdToFdVP)
 ...
 Else 
Call Amplitude_WAVE_SSDM_FdToFdVP(cplcFdFdVPL,cplcFdFdVPR,cplcFdFdVZL,cplcFdFdVZR,    & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_SSDM_FdToFdVP(MAhOS,MFdOS,MFuOS,MhhOS,MHpOS,MVG,MVP,            & 
& MVWpOS,MVZOS,MAh2OS,MFd2OS,MFu2OS,Mhh2OS,MHp2OS,MVG2,MVP2,MVWp2OS,MVZ2OS,              & 
& ZcplcFdFdAhL,ZcplcFdFdAhR,ZcplcFdFdhhL,ZcplcFdFdhhR,ZcplcFuFdHpL,ZcplcFuFdHpR,         & 
& ZcplcFdFdVGL,ZcplcFdFdVGR,ZcplcFdFdVPL,ZcplcFdFdVPR,ZcplcFuFdVWpL,ZcplcFuFdVWpR,       & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_SSDM_FdToFdVP(MAh,MFd,MFu,Mhh,MHp,MVG,MVP,MVWp,MVZ,             & 
& MAh2,MFd2,MFu2,Mhh2,MHp2,MVG2,MVP2,MVWp2,MVZ2,cplcFdFdAhL,cplcFdFdAhR,cplcFdFdhhL,     & 
& cplcFdFdhhR,cplcFuFdHpL,cplcFuFdHpR,cplcFdFdVGL,cplcFdFdVGR,cplcFdFdVPL,               & 
...
End Module Wrapper_OneLoopDecay_Fd_SSDM
