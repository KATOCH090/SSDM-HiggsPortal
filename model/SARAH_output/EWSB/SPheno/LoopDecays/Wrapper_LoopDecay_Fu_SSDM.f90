...
Module Wrapper_OneLoopDecay_Fu_SSDM
Use Model_Data_SSDM 
Use Kinematics 
Use OneLoopDecay_Fu_SSDM 
Use Control 
Use Settings 
...
Call Amplitude_Tree_SSDM_FuToFdVWp(cplcFuFdVWpL,cplcFuFdVWpR,MFd,MFu,MVWp,            & 
& MFd2,MFu2,MVWp2,AmpTreeFuToFdVWp)

  Else 
Call Amplitude_Tree_SSDM_FuToFdVWp(ZcplcFuFdVWpL,ZcplcFuFdVWpR,MFd,MFu,               & 
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_SSDM_FuToFdVWp(MLambda,em,gs,cplcFuFdVWpL,cplcFuFdVWpR,               & 
& MFdOS,MFuOS,MVWpOS,MRPFuToFdVWp,MRGFuToFdVWp)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_SSDM_FuToFdVWp(MLambda,em,gs,ZcplcFuFdVWpL,ZcplcFuFdVWpR,             & 
& MFdOS,MFuOS,MVWpOS,MRPFuToFdVWp,MRGFuToFdVWp)
...
Call Amplitude_WAVE_SSDM_FuToFdVWp(cplcFuFdVWpL,cplcFuFdVWpR,ctcplcFuFdVWpL,          & 
& ctcplcFuFdVWpR,MFd,MFd2,MFu,MFu2,MVWp,MVWp2,ZfDL,ZfDR,ZfUL,ZfUR,ZfVWp,AmpWaveFuToFdVWp)



!Vertex Corrections 
Call Amplitude_VERTEX_SSDM_FuToFdVWp(MAh,MFd,MFu,Mhh,MHp,MVG,MVP,MVWp,MVZ,            & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_SSDM_FuToFdVWp(MAh,MFd,MFu,Mhh,MHp,MVG,MVP,MVWp,             & 
...
& cplhhcVWpVWp,cplcHpVPVWp,cplcVWpVPVWp,cplcHpVWpVZ,cplcVWpVWpVZ,AmpVertexIRdrFuToFdVWp)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_SSDM_FuToFdVWp(MAhOS,MFdOS,MFuOS,MhhOS,MHpOS,MVG,            & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_SSDM_FuToFuhh(cplcFuFuhhL,cplcFuFuhhR,MFu,Mhh,MFu2,               & 
& Mhh2,AmpTreeFuToFuhh)

  Else 
Call Amplitude_Tree_SSDM_FuToFuhh(ZcplcFuFuhhL,ZcplcFuFuhhR,MFu,Mhh,MFu2,             & 
& Mhh2,AmpTreeFuToFuhh)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_SSDM_FuToFuhh(MLambda,em,gs,cplcFuFuhhL,cplcFuFuhhR,MFuOS,            & 
& MhhOS,MRPFuToFuhh,MRGFuToFuhh)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_SSDM_FuToFuhh(MLambda,em,gs,ZcplcFuFuhhL,ZcplcFuFuhhR,MFuOS,          & 
& MhhOS,MRPFuToFuhh,MRGFuToFuhh)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_SSDM_FuToFuhh(MLambda,em,gs,cplcFuFuhhL,cplcFuFuhhR,MFu,              & 
& Mhh,MRPFuToFuhh,MRGFuToFuhh)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_SSDM_FuToFuhh(MLambda,em,gs,ZcplcFuFuhhL,ZcplcFuFuhhR,MFu,            & 
& Mhh,MRPFuToFuhh,MRGFuToFuhh)
...
!Self-energy Corrections 
Call Amplitude_WAVE_SSDM_FuToFuhh(cplcFuFuhhL,cplcFuFuhhR,ctcplcFuFuhhL,              & 
& ctcplcFuFuhhR,MFu,MFu2,Mhh,Mhh2,Zfhh,ZfUL,ZfUR,AmpWaveFuToFuhh)



!Vertex Corrections 
Call Amplitude_VERTEX_SSDM_FuToFuhh(MAh,MFd,MFu,Mhh,MHp,MVG,MVP,MVWp,MVZ,             & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_SSDM_FuToFuhh(MAh,MFd,MFu,Mhh,MHp,MVG,MVP,MVWp,              & 
...
& cplhhVZVZ,AmpVertexIRdrFuToFuhh)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_SSDM_FuToFuhh(MAhOS,MFdOS,MFuOS,MhhOS,MHpOS,MVG,             & 
& MVP,MVWpOS,MVZOS,MAh2OS,MFd2OS,MFu2OS,Mhh2OS,MHp2OS,MVG2,MVP2,MVWp2OS,MVZ2OS,          & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_SSDM_FuToFuVZ(cplcFuFuVZL,cplcFuFuVZR,MFu,MVZ,MFu2,               & 
& MVZ2,AmpTreeFuToFuVZ)

  Else 
Call Amplitude_Tree_SSDM_FuToFuVZ(ZcplcFuFuVZL,ZcplcFuFuVZR,MFu,MVZ,MFu2,             & 
& MVZ2,AmpTreeFuToFuVZ)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_SSDM_FuToFuVZ(MLambda,em,gs,cplcFuFuVZL,cplcFuFuVZR,MFuOS,            & 
& MVZOS,MRPFuToFuVZ,MRGFuToFuVZ)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_SSDM_FuToFuVZ(MLambda,em,gs,ZcplcFuFuVZL,ZcplcFuFuVZR,MFuOS,          & 
& MVZOS,MRPFuToFuVZ,MRGFuToFuVZ)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_SSDM_FuToFuVZ(MLambda,em,gs,cplcFuFuVZL,cplcFuFuVZR,MFu,              & 
& MVZ,MRPFuToFuVZ,MRGFuToFuVZ)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_SSDM_FuToFuVZ(MLambda,em,gs,ZcplcFuFuVZL,ZcplcFuFuVZR,MFu,            & 
& MVZ,MRPFuToFuVZ,MRGFuToFuVZ)
...
!Self-energy Corrections 
Call Amplitude_WAVE_SSDM_FuToFuVZ(cplcFuFuVPL,cplcFuFuVPR,cplcFuFuVZL,cplcFuFuVZR,    & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_SSDM_FuToFuVZ(MAh,MFd,MFu,Mhh,MHp,MVG,MVP,MVWp,MVZ,             & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_SSDM_FuToFuVZ(MAh,MFd,MFu,Mhh,MHp,MVG,MVP,MVWp,              & 
...
& AmpVertexIRdrFuToFuVZ)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_SSDM_FuToFuVZ(MAhOS,MFdOS,MFuOS,MhhOS,MHpOS,MVG,             & 
& MVP,MVWpOS,MVZOS,MAh2OS,MFd2OS,MFu2OS,Mhh2OS,MHp2OS,MVG2,MVP2,MVWp2OS,MVZ2OS,          & 
...
!Self-energy Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_WAVE_SSDM_FuToFuVG(ZcplcFuFuVGL,ZcplcFuFuVGR,ctcplcFuFuVGL,            & 
& ctcplcFuFuVGR,MFuOS,MFu2OS,MVG,MVG2,ZfUL,ZfUR,ZfVG,AmpWaveFuToFuVG)

 Else 
Call Amplitude_WAVE_SSDM_FuToFuVG(cplcFuFuVGL,cplcFuFuVGR,ctcplcFuFuVGL,              & 
& ctcplcFuFuVGR,MFuOS,MFu2OS,MVG,MVG2,ZfUL,ZfUR,ZfVG,AmpWaveFuToFuVG)
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_SSDM_FuToFuVG(MAhOS,MFdOS,MFuOS,MhhOS,MHpOS,MVG,MVP,            & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_SSDM_FuToFuVG(MAh,MFd,MFu,Mhh,MHp,MVG,MVP,MVWp,MVZ,             & 
...
!Self-energy Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_WAVE_SSDM_FuToFuVP(ZcplcFuFuVPL,ZcplcFuFuVPR,ZcplcFuFuVZL,             & 
...
& MFu2OS,MVP,MVP2,ZfUL,ZfUR,ZfVP,ZfVZVP,AmpWaveFuToFuVP)
 ...
 Else 
Call Amplitude_WAVE_SSDM_FuToFuVP(cplcFuFuVPL,cplcFuFuVPR,cplcFuFuVZL,cplcFuFuVZR,    & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_SSDM_FuToFuVP(MAhOS,MFdOS,MFuOS,MhhOS,MHpOS,MVG,MVP,            & 
& MVWpOS,MVZOS,MAh2OS,MFd2OS,MFu2OS,Mhh2OS,MHp2OS,MVG2,MVP2,MVWp2OS,MVZ2OS,              & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_SSDM_FuToFuVP(MAh,MFd,MFu,Mhh,MHp,MVG,MVP,MVWp,MVZ,             & 
& MAh2,MFd2,MFu2,Mhh2,MHp2,MVG2,MVP2,MVWp2,MVZ2,cplcFuFuAhL,cplcFuFuAhR,cplcFuFdHpL,     & 
...
End Module Wrapper_OneLoopDecay_Fu_SSDM
