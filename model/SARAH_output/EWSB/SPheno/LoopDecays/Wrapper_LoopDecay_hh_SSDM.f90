...
Module Wrapper_OneLoopDecay_hh_SSDM
Use Model_Data_SSDM 
Use Kinematics 
Use OneLoopDecay_hh_SSDM 
Use Control 
Use Settings 
...
& MHp2OS,MssOS,Mss2OS,MAhOS,MAh2OS,MhhOS,Mhh2OS,MVZOS,MVZ2OS,MVWpOS,MVWp2OS,             & 
...
& ZW,ZZ,g1,g2,g3,LS,LSH,Lam,Yu,Yd,Ye,MS2,mu2,v,dg1,dg2,dg3,dYu,dYd,dYe,dMS2,             & 
& dmu2,dLS,dLSH,dLam,dv,dZDL,dZDR,dZUL,dZUR,dZEL,dZER,dSinTW,dCosTW,dTanTW,              & 
& ZfVG,ZfHp,Zfss,ZfvL,ZfAh,Zfhh,ZfVP,ZfVZ,ZfVWp,ZfDL,ZfDR,ZfUL,ZfUR,ZfEL,ZfER,           & 
& ZfVPVZ,ZfVZVP,cplAhAhAhAh1,cplAhAhcVWpVWp1,cplAhAhhh,cplAhAhhhhh1,cplAhAhHpcHp1,       & 
& cplAhAhssss1,cplAhAhVZVZ1,cplAhcHpVPVWp1,cplAhcHpVWp,cplAhcHpVWpVZ1,cplAhhhVZ,         & 
& cplAhHpcVWp,cplAhHpcVWpVP1,cplAhHpcVWpVZ1,cplcFdFdAhL,cplcFdFdAhR,cplcFdFdhhL,         & 
...
& cplcFvFvVZR,cplcgAgWCVWp,cplcgAgWpcVWp,cplcgWCgAcVWp,cplcgWCgWCAh,cplcgWCgWChh,        & 
& cplcgWCgWCVP,cplcgWCgWCVZ,cplcgWCgZcHp,cplcgWCgZcVWp,cplcgWpgAHp,cplcgWpgAVWp,         & 
& cplcgWpgWpAh,cplcgWpgWphh,cplcgWpgWpVP,cplcgWpgWpVZ,cplcgWpgZHp,cplcgWpgZVWp,          & 
& cplcgZgAhh,cplcgZgWCHp,cplcgZgWCVWp,cplcgZgWpcHp,cplcgZgWpcVWp,cplcgZgZhh,             & 
& cplcHpVPVWp,cplcHpVWpVZ,cplcVWpcVWpVWpVWp1Q,cplcVWpcVWpVWpVWp2Q,cplcVWpcVWpVWpVWp3Q,   & 
...
& cplcVWpVWpVZVZ3Q,cplhhcHpVPVWp1,cplhhcHpVWp,cplhhcHpVWpVZ1,cplhhcVWpVWp,               & 
& cplhhhhcVWpVWp1,cplhhhhhh,cplhhhhhhhh1,cplhhhhHpcHp1,cplhhhhssss1,cplhhhhVZVZ1,        & 
& cplhhHpcHp,cplhhHpcVWp,cplhhHpcVWpVP1,cplhhHpcVWpVZ1,cplhhssss,cplhhVZVZ,              & 
& cplHpcHpcVWpVWp1,cplHpcHpVP,cplHpcHpVPVP1,cplHpcHpVPVZ1,cplHpcHpVZ,cplHpcHpVZVZ1,      & 
& cplHpcVWpVP,cplHpcVWpVZ,cplHpHpcHpcHp1,cplHpsssscHp1,cplssssssss1,ctcplAhAhhh,         & 
& ctcplAhhhVZ,ctcplcFdFdhhL,ctcplcFdFdhhR,ctcplcFeFehhL,ctcplcFeFehhR,ctcplcFuFuhhL,     & 
& ctcplcFuFuhhR,ctcplhhcVWpVWp,ctcplhhhhhh,ctcplhhHpcHp,ctcplhhHpcVWp,ctcplhhssss,       & 
& ctcplhhVZVZ,GcplcHpVPVWp,GcplhhcHpVWp,GcplhhHpcHp,GcplHpcVWpVP,GosZcplcHpVPVWp,        & 
& GosZcplhhcHpVWp,GosZcplhhHpcHp,GosZcplHpcVWpVP,GZcplcHpVPVWp,GZcplhhcHpVWp,            & 
& GZcplhhHpcHp,GZcplHpcVWpVP,ZcplAhAhhh,ZcplAhhhVZ,ZcplcFdFdhhL,ZcplcFdFdhhR,            & 
...
Real(dp),Intent(in) :: dg1,dg2,dg3,dMS2,dv,dSinTW,dCosTW,dTanTW

Complex(dp),Intent(in) :: dYu(3,3),dYd(3,3),dYe(3,3),dmu2,dLS,dLSH,dLam,dZDL(3,3),dZDR(3,3),dZUL(3,3),          & 
...
& ctcplhhssss,ctcplhhVZVZ,GcplcHpVPVWp,GcplhhcHpVWp,GcplhhHpcHp,GcplHpcVWpVP,            & 
...
& ZcplcFuFuhhR(3,3),ZcplhhcVWpVWp,Zcplhhhhhh,ZcplhhHpcHp,ZcplhhHpcVWp,Zcplhhssss,        & 
& ZcplhhVZVZ

Real(dp), Intent(in) :: em, gs 
Complex(dp),Intent(in) :: ZfVG,ZfHp,Zfss,ZfvL(3,3),ZfAh,Zfhh,ZfVP,ZfVZ,ZfVWp,ZfDL(3,3),ZfDR(3,3),               & 
& ZfUL(3,3),ZfUR(3,3),ZfEL(3,3),ZfER(3,3),ZfVPVZ,ZfVZVP

Real(dp),Intent(in) :: MFdOS(3),MFd2OS(3),MFuOS(3),MFu2OS(3),MFeOS(3),MFe2OS(3),MHpOS,MHp2OS,MssOS,          & 
& Mss2OS,MAhOS,MAh2OS,MhhOS,Mhh2OS,MVZOS,MVZ2OS,MVWpOS,MVWp2OS
...
Real(dp), Intent(out) :: gP1Lhh(1,49) 
...
Call Amplitude_Tree_SSDM_hhTocFdFd(cplcFdFdhhL,cplcFdFdhhR,MFd,Mhh,MFd2,              & 
& Mhh2,AmpTreehhTocFdFd)

  Else 
Call Amplitude_Tree_SSDM_hhTocFdFd(ZcplcFdFdhhL,ZcplcFdFdhhR,MFd,Mhh,MFd2,            & 
& Mhh2,AmpTreehhTocFdFd)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_SSDM_hhTocFdFd(MLambda,em,gs,cplcFdFdhhL,cplcFdFdhhR,MFdOS,           & 
& MhhOS,MRPhhTocFdFd,MRGhhTocFdFd)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_SSDM_hhTocFdFd(MLambda,em,gs,ZcplcFdFdhhL,ZcplcFdFdhhR,               & 
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_SSDM_hhTocFdFd(MLambda,em,gs,cplcFdFdhhL,cplcFdFdhhR,MFd,             & 
...
Call Amplitude_WAVE_SSDM_hhTocFdFd(cplcFdFdhhL,cplcFdFdhhR,ctcplcFdFdhhL,             & 
& ctcplcFdFdhhR,MFd,MFd2,Mhh,Mhh2,ZfDL,ZfDR,Zfhh,AmpWavehhTocFdFd)



!Vertex Corrections 
Call Amplitude_VERTEX_SSDM_hhTocFdFd(MAh,MFd,MFu,Mhh,MHp,MVG,MVP,MVWp,MVZ,            & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_SSDM_hhTocFdFd(MAh,MFd,MFu,Mhh,MHp,MVG,MVP,MVWp,             & 
...
& cplhhVZVZ,AmpVertexIRdrhhTocFdFd)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_SSDM_hhTocFdFd(MAhOS,MFdOS,MFuOS,MhhOS,MHpOS,MVG,            & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_SSDM_hhTocFeFe(cplcFeFehhL,cplcFeFehhR,MFe,Mhh,MFe2,              & 
& Mhh2,AmpTreehhTocFeFe)

  Else 
Call Amplitude_Tree_SSDM_hhTocFeFe(ZcplcFeFehhL,ZcplcFeFehhR,MFe,Mhh,MFe2,            & 
& Mhh2,AmpTreehhTocFeFe)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_SSDM_hhTocFeFe(MLambda,em,gs,cplcFeFehhL,cplcFeFehhR,MFeOS,           & 
& MhhOS,MRPhhTocFeFe,MRGhhTocFeFe)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_SSDM_hhTocFeFe(MLambda,em,gs,ZcplcFeFehhL,ZcplcFeFehhR,               & 
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_SSDM_hhTocFeFe(MLambda,em,gs,cplcFeFehhL,cplcFeFehhR,MFe,             & 
...
!Self-energy Corrections 
Call Amplitude_WAVE_SSDM_hhTocFeFe(cplcFeFehhL,cplcFeFehhR,ctcplcFeFehhL,             & 
& ctcplcFeFehhR,MFe,MFe2,Mhh,Mhh2,ZfEL,ZfER,Zfhh,AmpWavehhTocFeFe)



!Vertex Corrections 
Call Amplitude_VERTEX_SSDM_hhTocFeFe(MAh,MFe,Mhh,MHp,MVP,MVWp,MVZ,MAh2,               & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_SSDM_hhTocFeFe(MAh,MFe,Mhh,MHp,MVP,MVWp,MVZ,MAh2,            & 
& MFe2,Mhh2,MHp2,MVP2,MVWp2,MVZ2,cplAhAhhh,cplcFeFeAhL,cplcFeFeAhR,cplAhhhVZ,            & 
& cplcFeFehhL,cplcFeFehhR,cplcFvFeHpL,cplcFvFeHpR,cplcFeFeVPL,cplcFeFeVPR,               & 
& cplcFvFeVWpL,cplcFvFeVWpR,cplcFeFeVZL,cplcFeFeVZR,cplcFeFvcHpL,cplcFeFvcHpR,           & 
& cplcFeFvcVWpL,cplcFeFvcVWpR,cplhhhhhh,cplhhHpcHp,cplhhHpcVWp,cplhhcHpVWp,              & 
& cplhhcVWpVWp,cplhhVZVZ,AmpVertexIRdrhhTocFeFe)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_SSDM_hhTocFeFe(MAhOS,MFeOS,MhhOS,MHpOS,MVP,MVWpOS,           & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_SSDM_hhTocFuFu(cplcFuFuhhL,cplcFuFuhhR,MFu,Mhh,MFu2,              & 
& Mhh2,AmpTreehhTocFuFu)

  Else 
Call Amplitude_Tree_SSDM_hhTocFuFu(ZcplcFuFuhhL,ZcplcFuFuhhR,MFu,Mhh,MFu2,            & 
& Mhh2,AmpTreehhTocFuFu)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_SSDM_hhTocFuFu(MLambda,em,gs,cplcFuFuhhL,cplcFuFuhhR,MFuOS,           & 
& MhhOS,MRPhhTocFuFu,MRGhhTocFuFu)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_SSDM_hhTocFuFu(MLambda,em,gs,ZcplcFuFuhhL,ZcplcFuFuhhR,               & 
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_SSDM_hhTocFuFu(MLambda,em,gs,cplcFuFuhhL,cplcFuFuhhR,MFu,             & 
...
!Self-energy Corrections 
Call Amplitude_WAVE_SSDM_hhTocFuFu(cplcFuFuhhL,cplcFuFuhhR,ctcplcFuFuhhL,             & 
& ctcplcFuFuhhR,MFu,MFu2,Mhh,Mhh2,Zfhh,ZfUL,ZfUR,AmpWavehhTocFuFu)



!Vertex Corrections 
Call Amplitude_VERTEX_SSDM_hhTocFuFu(MAh,MFd,MFu,Mhh,MHp,MVG,MVP,MVWp,MVZ,            & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_SSDM_hhTocFuFu(MAh,MFd,MFu,Mhh,MHp,MVG,MVP,MVWp,             & 
...
& cplhhVZVZ,AmpVertexIRdrhhTocFuFu)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_SSDM_hhTocFuFu(MAhOS,MFdOS,MFuOS,MhhOS,MHpOS,MVG,            & 
& MVP,MVWpOS,MVZOS,MAh2OS,MFd2OS,MFu2OS,Mhh2OS,MHp2OS,MVG2,MVP2,MVWp2OS,MVZ2OS,          & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_SSDM_hhTohhhh(cplhhhhhh,Mhh,Mhh2,AmpTreehhTohhhh)

  Else 
Call Amplitude_Tree_SSDM_hhTohhhh(Zcplhhhhhh,Mhh,Mhh2,AmpTreehhTohhhh)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_SSDM_hhTohhhh(MLambda,em,gs,cplhhhhhh,MhhOS,MRPhhTohhhh,              & 
& MRGhhTohhhh)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_SSDM_hhTohhhh(MLambda,em,gs,Zcplhhhhhh,MhhOS,MRPhhTohhhh,             & 
& MRGhhTohhhh)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_SSDM_hhTohhhh(MLambda,em,gs,cplhhhhhh,Mhh,MRPhhTohhhh,MRGhhTohhhh)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_SSDM_hhTohhhh(MLambda,em,gs,Zcplhhhhhh,Mhh,MRPhhTohhhh,               & 
& MRGhhTohhhh)
...
!Self-energy Corrections 
Call Amplitude_WAVE_SSDM_hhTohhhh(cplhhhhhh,ctcplhhhhhh,Mhh,Mhh2,Zfhh,AmpWavehhTohhhh)



!Vertex Corrections 
Call Amplitude_VERTEX_SSDM_hhTohhhh(MAh,MFd,MFe,MFu,Mhh,MHp,Mss,MVWp,MVZ,             & 
& MAh2,MFd2,MFe2,MFu2,Mhh2,MHp2,Mss2,MVWp2,MVZ2,cplAhAhhh,cplAhhhVZ,cplcFdFdhhL,         & 
...
& cplhhhhcVWpVWp1,cplhhhhVZVZ1,AmpVertexhhTohhhh)

If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_SSDM_hhTohhhh(MAh,MFd,MFe,MFu,Mhh,MHp,Mss,MVWp,              & 
& MVZ,MAh2,MFd2,MFe2,MFu2,Mhh2,MHp2,Mss2,MVWp2,MVZ2,cplAhAhhh,cplAhhhVZ,cplcFdFdhhL,     & 
& cplcFdFdhhR,cplcFeFehhL,cplcFeFehhR,cplcFuFuhhL,cplcFuFuhhR,cplcgWpgWphh,              & 
& cplcgWCgWChh,cplcgZgZhh,cplhhhhhh,cplhhHpcHp,cplhhHpcVWp,cplhhssss,cplhhcHpVWp,        & 
& cplhhcVWpVWp,cplhhVZVZ,cplAhAhhhhh1,cplhhhhhhhh1,cplhhhhHpcHp1,cplhhhhssss1,           & 
& cplhhhhcVWpVWp1,cplhhhhVZVZ1,AmpVertexIRdrhhTohhhh)

 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_SSDM_hhTohhhh(MAhOS,MFdOS,MFeOS,MFuOS,MhhOS,MHpOS,           & 
& MssOS,MVWpOS,MVZOS,MAh2OS,MFd2OS,MFe2OS,MFu2OS,Mhh2OS,MHp2OS,Mss2OS,MVWp2OS,           & 
& MVZ2OS,cplAhAhhh,cplAhhhVZ,cplcFdFdhhL,cplcFdFdhhR,cplcFeFehhL,cplcFeFehhR,            & 
& cplcFuFuhhL,cplcFuFuhhR,cplcgWpgWphh,cplcgWCgWChh,cplcgZgZhh,Zcplhhhhhh,               & 
& cplhhHpcHp,cplhhHpcVWp,cplhhssss,cplhhcHpVWp,cplhhcVWpVWp,cplhhVZVZ,cplAhAhhhhh1,      & 
& cplhhhhhhhh1,cplhhhhHpcHp1,cplhhhhssss1,cplhhhhcVWpVWp1,cplhhhhVZVZ1,AmpVertexIRoshhTohhhh)
...
& MVZ,MAh2,MFd2,MFe2,MFu2,Mhh2,MHp2,Mss2,MVWp2,MVZ2,cplAhAhhh,cplAhhhVZ,cplcFdFdhhL,     & 
& cplcFdFdhhR,cplcFeFehhL,cplcFeFehhR,cplcFuFuhhL,cplcFuFuhhR,cplcgWpgWphh,              & 
& cplcgWCgWChh,cplcgZgZhh,Zcplhhhhhh,cplhhHpcHp,cplhhHpcVWp,cplhhssss,cplhhcHpVWp,       & 
& cplhhcVWpVWp,cplhhVZVZ,cplAhAhhhhh1,cplhhhhhhhh1,cplhhhhHpcHp1,cplhhhhssss1,           & 
& cplhhhhcVWpVWp1,cplhhhhVZVZ1,AmpVertexIRoshhTohhhh)
...
& cplhhHpcVWp,cplhhssss,cplhhcHpVWp,cplhhcVWpVWp,cplhhVZVZ,cplAhAhhhhh1,cplhhhhhhhh1,    & 
& cplhhhhHpcHp1,cplhhhhssss1,cplhhhhcVWpVWp1,cplhhhhVZVZ1,AmpVertexIRoshhTohhhh)
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_SSDM_hhTossss(cplhhssss,Mhh,Mss,Mhh2,Mss2,AmpTreehhTossss)

  Else 
Call Amplitude_Tree_SSDM_hhTossss(Zcplhhssss,Mhh,Mss,Mhh2,Mss2,AmpTreehhTossss)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_SSDM_hhTossss(MLambda,em,gs,cplhhssss,MhhOS,MssOS,MRPhhTossss,        & 
& MRGhhTossss)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_SSDM_hhTossss(MLambda,em,gs,Zcplhhssss,MhhOS,MssOS,MRPhhTossss,       & 
& MRGhhTossss)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_SSDM_hhTossss(MLambda,em,gs,cplhhssss,Mhh,Mss,MRPhhTossss,            & 
& MRGhhTossss)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_SSDM_hhTossss(MLambda,em,gs,Zcplhhssss,Mhh,Mss,MRPhhTossss,           & 
& MRGhhTossss)
...
!Self-energy Corrections 
Call Amplitude_WAVE_SSDM_hhTossss(cplhhssss,ctcplhhssss,Mhh,Mhh2,Mss,Mss2,            & 
& Zfhh,Zfss,AmpWavehhTossss)



!Vertex Corrections 
Call Amplitude_VERTEX_SSDM_hhTossss(MAh,Mhh,MHp,Mss,MAh2,Mhh2,MHp2,Mss2,              & 
& cplAhAhhh,cplhhhhhh,cplhhHpcHp,cplhhssss,cplAhAhssss1,cplhhhhssss1,cplHpsssscHp1,      & 
& cplssssssss1,AmpVertexhhTossss)

If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_SSDM_hhTossss(MAh,Mhh,MHp,Mss,MAh2,Mhh2,MHp2,Mss2,           & 
& cplAhAhhh,cplhhhhhh,cplhhHpcHp,cplhhssss,cplAhAhssss1,cplhhhhssss1,cplHpsssscHp1,      & 
& cplssssssss1,AmpVertexIRdrhhTossss)

 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_SSDM_hhTossss(MAhOS,MhhOS,MHpOS,MssOS,MAh2OS,Mhh2OS,         & 
& MHp2OS,Mss2OS,cplAhAhhh,cplhhhhhh,cplhhHpcHp,Zcplhhssss,cplAhAhssss1,cplhhhhssss1,     & 
& cplHpsssscHp1,cplssssssss1,AmpVertexIRoshhTossss)

   Else 
 ! DR and Z-factors 
Call Amplitude_IR_VERTEX_SSDM_hhTossss(MAh,Mhh,MHp,Mss,MAh2,Mhh2,MHp2,Mss2,           & 
& cplAhAhhh,cplhhhhhh,cplhhHpcHp,Zcplhhssss,cplAhAhssss1,cplhhhhssss1,cplHpsssscHp1,     & 
& cplssssssss1,AmpVertexIRoshhTossss)
 ...
 ! OS and no Z-factors 
Call Amplitude_IR_VERTEX_SSDM_hhTossss(MAhOS,MhhOS,MHpOS,MssOS,MAh2OS,Mhh2OS,         & 
& MHp2OS,Mss2OS,cplAhAhhh,cplhhhhhh,cplhhHpcHp,cplhhssss,cplAhAhssss1,cplhhhhssss1,      & 
& cplHpsssscHp1,cplssssssss1,AmpVertexIRoshhTossss)
...
gt1=1 
i4 = isave 
If (((OSkinematics).and.(Abs(MhhOS).gt.(Abs(MssOS)+Abs(MssOS)))).or.((.not.OSkinematics).and.(Abs(Mhh).gt.(Abs(Mss)+Abs(Mss))))) Then 
 If (DebugLoopDecays) Then 
  Write(*,*)  
  AmpSum2hhTossss = AmpTreehhTossss
If (OSkinematics) Then 
...
! Calculate Partial widths 
helfactor = 1._dp 
If (AmpSqhhTossss.eq.0._dp) Then 
  gP1Lhh(gt1,i4) = 0._dp 
Else 
If (OSkinematics) Then 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_SSDM_hhTocVWpVWp(cplhhcVWpVWp,Mhh,MVWp,Mhh2,MVWp2,AmpTreehhTocVWpVWp)

  Else 
Call Amplitude_Tree_SSDM_hhTocVWpVWp(ZcplhhcVWpVWp,Mhh,MVWp,Mhh2,MVWp2,               & 
& AmpTreehhTocVWpVWp)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_SSDM_hhTocVWpVWp(MLambda,em,gs,cplhhcVWpVWp,MhhOS,MVWpOS,             & 
& MRPhhTocVWpVWp,MRGhhTocVWpVWp)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_SSDM_hhTocVWpVWp(MLambda,em,gs,ZcplhhcVWpVWp,MhhOS,MVWpOS,            & 
& MRPhhTocVWpVWp,MRGhhTocVWpVWp)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_SSDM_hhTocVWpVWp(MLambda,em,gs,cplhhcVWpVWp,Mhh,MVWp,MRPhhTocVWpVWp,  & 
& MRGhhTocVWpVWp)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_SSDM_hhTocVWpVWp(MLambda,em,gs,ZcplhhcVWpVWp,Mhh,MVWp,MRPhhTocVWpVWp, & 
& MRGhhTocVWpVWp)
...
!Self-energy Corrections 
Call Amplitude_WAVE_SSDM_hhTocVWpVWp(cplhhcVWpVWp,ctcplhhcVWpVWp,Mhh,Mhh2,            & 
& MVWp,MVWp2,Zfhh,ZfVWp,AmpWavehhTocVWpVWp)



!Vertex Corrections 
Call Amplitude_VERTEX_SSDM_hhTocVWpVWp(MAh,MFd,MFe,MFu,Mhh,MHp,MVP,MVWp,              & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_SSDM_hhTocVWpVWp(MAh,MFd,MFe,MFu,Mhh,MHp,MVP,MVWp,           & 
& MVZ,MAh2,MFd2,MFe2,MFu2,Mhh2,MHp2,MVP2,MVWp2,MVZ2,cplAhAhhh,cplAhhhVZ,cplAhHpcVWp,     & 
& cplAhcHpVWp,cplcFdFdhhL,cplcFdFdhhR,cplcFuFdVWpL,cplcFuFdVWpR,cplcFeFehhL,             & 
& cplcFeFehhR,cplcFvFeVWpL,cplcFvFeVWpR,cplcFuFuhhL,cplcFuFuhhR,cplcFdFucVWpL,           & 
& cplcFdFucVWpR,cplcFeFvcVWpL,cplcFeFvcVWpR,cplcgZgAhh,cplcgWpgAVWp,cplcgWCgAcVWp,       & 
...
& cplcVWpVWpVZVZ1Q,AmpVertexIRdrhhTocVWpVWp)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_SSDM_hhTocVWpVWp(MAhOS,MFdOS,MFeOS,MFuOS,MhhOS,              & 
& MHpOS,MVP,MVWpOS,MVZOS,MAh2OS,MFd2OS,MFe2OS,MFu2OS,Mhh2OS,MHp2OS,MVP2,MVWp2OS,         & 
...
!Tree Level 
  If (.not.ExternalZfactors) Then 
Call Amplitude_Tree_SSDM_hhToVZVZ(cplhhVZVZ,Mhh,MVZ,Mhh2,MVZ2,AmpTreehhToVZVZ)

  Else 
Call Amplitude_Tree_SSDM_hhToVZVZ(ZcplhhVZVZ,Mhh,MVZ,Mhh2,MVZ2,AmpTreehhToVZVZ)
...
If (OSkinematics) Then 
  If (.not.ExternalZfactors) Then 
 ! OS and no Z-factors 
Call Gamma_Real_SSDM_hhToVZVZ(MLambda,em,gs,cplhhVZVZ,MhhOS,MVZOS,MRPhhToVZVZ,        & 
& MRGhhToVZVZ)

  Else 
 ! OS and Z-factors 
Call Gamma_Real_SSDM_hhToVZVZ(MLambda,em,gs,ZcplhhVZVZ,MhhOS,MVZOS,MRPhhToVZVZ,       & 
& MRGhhToVZVZ)
...
Else 
 ! DR and no Z-factors 
  If (.not.ExternalZfactors) Then 
Call Gamma_Real_SSDM_hhToVZVZ(MLambda,em,gs,cplhhVZVZ,Mhh,MVZ,MRPhhToVZVZ,            & 
& MRGhhToVZVZ)

  Else 
 ! DR and Z-factors 
Call Gamma_Real_SSDM_hhToVZVZ(MLambda,em,gs,ZcplhhVZVZ,Mhh,MVZ,MRPhhToVZVZ,           & 
& MRGhhToVZVZ)
...
!Self-energy Corrections 
Call Amplitude_WAVE_SSDM_hhToVZVZ(cplhhVZVZ,ctcplhhVZVZ,Mhh,Mhh2,MVZ,MVZ2,            & 
& Zfhh,ZfVZ,AmpWavehhToVZVZ)



!Vertex Corrections 
Call Amplitude_VERTEX_SSDM_hhToVZVZ(MAh,MFd,MFe,MFu,Mhh,MHp,MVWp,MVZ,MAh2,            & 
...
If (ShiftIRdiv) Then 
Call Amplitude_IR_VERTEX_SSDM_hhToVZVZ(MAh,MFd,MFe,MFu,Mhh,MHp,MVWp,MVZ,              & 
...
& cplcVWpVWpVZVZ3Q,cplcVWpVWpVZVZ1Q,AmpVertexIRdrhhToVZVZ)
 ...
 If (ExternalZfactors) Then 
  If (OSkinematics) Then 
 ! OS and Z-factors 
Call Amplitude_IR_VERTEX_SSDM_hhToVZVZ(MAhOS,MFdOS,MFeOS,MFuOS,MhhOS,MHpOS,           & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_SSDM_hhToFvcFv(MFeOS,MhhOS,MHpOS,MVWpOS,MVZOS,MFe2OS,           & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_SSDM_hhToFvcFv(MFe,Mhh,MHp,MVWp,MVZ,MFe2,Mhh2,MHp2,             & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_SSDM_hhTohhVP(MFdOS,MFeOS,MFuOS,MhhOS,MHpOS,MVP,MVWpOS,         & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_SSDM_hhTohhVP(MFd,MFe,MFu,Mhh,MHp,MVP,MVWp,MFd2,MFe2,           & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_SSDM_hhTohhVZ(MFdOS,MFeOS,MFuOS,MhhOS,MHpOS,MVWpOS,             & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_SSDM_hhTohhVZ(MFd,MFe,MFu,Mhh,MHp,MVWp,MVZ,MFd2,MFe2,           & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_SSDM_hhToVGVG(MFdOS,MFuOS,MhhOS,MVG,MFd2OS,MFu2OS,              & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_SSDM_hhToVGVG(MFd,MFu,Mhh,MVG,MFd2,MFu2,Mhh2,MVG2,              & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_SSDM_hhToVPVP(MFdOS,MFeOS,MFuOS,MhhOS,MHpOS,MVP,MVWpOS,         & 
& MFd2OS,MFe2OS,MFu2OS,Mhh2OS,MHp2OS,MVP2,MVWp2OS,cplcFdFdhhL,cplcFdFdhhR,               & 
& cplcFdFdVPL,cplcFdFdVPR,cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,               & 
& cplcFuFuhhL,cplcFuFuhhR,cplcFuFuVPL,cplcFuFuVPR,cplcgWpgWphh,cplcgWpgWpVP,             & 
& cplcgWCgWChh,cplcgWCgWCVP,cplhhHpcHp,cplhhHpcVWp,cplhhcHpVWp,cplhhcVWpVWp,             & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_SSDM_hhToVPVP(MFd,MFe,MFu,Mhh,MHp,MVP,MVWp,MFd2,MFe2,           & 
& MFu2,Mhh2,MHp2,MVP2,MVWp2,cplcFdFdhhL,cplcFdFdhhR,cplcFdFdVPL,cplcFdFdVPR,             & 
& cplcFeFehhL,cplcFeFehhR,cplcFeFeVPL,cplcFeFeVPR,cplcFuFuhhL,cplcFuFuhhR,               & 
& cplcFuFuVPL,cplcFuFuVPR,cplcgWpgWphh,cplcgWpgWpVP,cplcgWCgWChh,cplcgWCgWCVP,           & 
& cplhhHpcHp,cplhhHpcVWp,cplhhcHpVWp,cplhhcVWpVWp,cplHpcHpVP,cplHpcVWpVP,cplcHpVPVWp,    & 
...
!Vertex Corrections 
 If (ExternalZfactors) Then 
Call Amplitude_VERTEX_SSDM_hhToVPVZ(MFdOS,MFeOS,MFuOS,MhhOS,MHpOS,MVP,MVWpOS,         & 
...
!Vertex Corrections 
Call Amplitude_VERTEX_SSDM_hhToVPVZ(MFd,MFe,MFu,Mhh,MHp,MVP,MVWp,MVZ,MFd2,            & 
...
End Module Wrapper_OneLoopDecay_hh_SSDM
