...
& g2,g3,LS,LSH,Lam,Yu,Yd,Ye,MS2,mu2,kont)
...
& cplcFuFuVZR(3,3),cplcFvFvVZL(3,3),cplcFvFvVZR(3,3),cplcgAgWpcVWp,cplcgGgGVG,           & 
& cplcgWCgAcVWp,cplcgWCgWCAh,cplcgWCgWChh,cplcgWCgWCVP,cplcgWCgWCVZ,cplcgWCgZcHp,        & 
& cplcgWCgZcVWp,cplcgWpgWpAh,cplcgWpgWphh,cplcgWpgWpVP,cplcgWpgWpVZ,cplcgWpgZHp,         & 
& cplcgZgWCHp,cplcgZgWpcHp,cplcgZgWpcVWp,cplcgZgZhh,cplcHpVPVWp,cplcHpVWpVZ,             & 
& cplcUFdFdAhL(3,3),cplcUFdFdAhR(3,3),cplcUFdFdhhL(3,3),cplcUFdFdhhR(3,3),               & 
...
& cplcUFdFucVWpL(3,3),cplcUFdFucVWpR(3,3),cplcUFeFeAhL(3,3),cplcUFeFeAhR(3,3),           & 
...
& cplhhssss,cplhhVZVZ,cplHpcHpcVWpVWp,cplHpcHpVP,cplHpcHpVPVP,cplHpcHpVPVZ,              & 
& cplHpcHpVZ,cplHpcHpVZVZ,cplHpcVWpVP,cplHpcVWpVZ,cplHpHpcHpcHp,cplHpsssscHp,            & 
& cplssssssss,cplVGVGVG,cplVGVGVGVG1,cplVGVGVGVG2,cplVGVGVGVG3
...
& v,Lam,LSH,LS,cplcUFdFdAhL,cplcUFdFdAhR,cplcUFdFdhhL,cplcUFdFdhhR,cplcUFdFdVGL,         & 
...
If (NewGBC) Then 
Call CalculatePi2S(125._dp**2,v,g1,g2,g3,LS,LSH,Lam,Yu,Yd,Ye,MS2,mu2,kont,            & 
& ti_ep2L,Pi2S_EffPot,PiP2S_EffPot)

Else 
Call CalculatePi2S(0._dp,v,g1,g2,g3,LS,LSH,Lam,Yu,Yd,Ye,MS2,mu2,kont,ti_ep2L,         & 
...
End if 
Call SolveTadpoleEquations(g1,g2,g3,LS,LSH,Lam,Yu,Yd,Ye,MS2,mu2,v,Tad1Loop)
...
Call OneLoopHp(g2,mu21L,Lam,v,MVWp,MVWp2,MAh,MAh2,MFd,MFd2,MFu,MFu2,MFe,              & 
& MFe2,MHp,MHp2,Mhh,Mhh2,MVZ,MVZ2,Mss,Mss2,cplAhcHpVWp,cplcFdFucHpL,cplcFdFucHpR,        & 
...
Call OneLoopss(MS2,LSH,v,Mss,Mss2,Mhh,Mhh2,MAh,MAh2,MHp,MHp2,cplhhssss,               & 
& cplAhAhssss,cplhhhhssss,cplHpsssscHp,cplssssssss,0.1_dp*delta_mass,Mss_1L,             & 
& Mss2_1L,kont)

Call OneLoopAh(g1,g2,mu22L,Lam,v,TW,Mhh,Mhh2,MAh,MAh2,MFd,MFd2,MFe,MFe2,              & 
& MFu,MFu2,MVZ,MVZ2,MVWp,MVWp2,MHp,MHp2,Mss,Mss2,cplAhAhhh,cplcFdFdAhL,cplcFdFdAhR,      & 
...
Call OneLoophh(mu22L,Lam,v,MAh,MAh2,MVZ,MVZ2,MFd,MFd2,MFe,MFe2,MFu,MFu2,              & 
& Mhh,Mhh2,MHp,MHp2,MVWp,MVWp2,Mss,Mss2,cplAhAhhh,cplAhhhVZ,cplcFdFdhhL,cplcFdFdhhR,     & 
...
& Mss,Mss2,MVWp,MVWp2,MVZ,MVZ2,TW,ZDR,ZER,ZUR,ZDL,ZEL,ZUL,ZW,ZZ,kont)
...
mi2 = 0._dp 
mi2 = mi2+mu2
mi2 = mi2+(Lam*v**2)/2._dp
mi2 = mi2+(g2**2*v**2*RXiWp)/4._dp
...
Subroutine OneLoopss(MS2,LSH,v,Mss,Mss2,Mhh,Mhh2,MAh,MAh2,MHp,MHp2,cplhhssss,         & 
& cplAhAhssss,cplhhhhssss,cplHpsssscHp,cplssssssss,delta,mass,mass2,kont)

Real(dp), Intent(in) :: Mss,Mss2,Mhh,Mhh2,MAh,MAh2,MHp,MHp2

Real(dp), Intent(in) :: MS2,v

Complex(dp), Intent(in) :: LSH

Complex(dp), Intent(in) :: cplhhssss,cplAhAhssss,cplhhhhssss,cplHpsssscHp,cplssssssss
...
& cplhhhhssss,cplHpsssscHp,cplssssssss,kont,PiSf)
...
Subroutine Pi1Loopss(p2,Mss,Mss2,Mhh,Mhh2,MAh,MAh2,MHp,MHp2,cplhhssss,cplAhAhssss,    & 
& cplhhhhssss,cplHpsssscHp,cplssssssss,kont,res)
...
B0m2 = Real(SA_B0(p2,Mss2,Mhh2),dp) 
coup1 = cplhhssss
...
Subroutine DerPi1Loopss(p2,Mss,Mss2,Mhh,Mhh2,MAh,MAh2,MHp,MHp2,cplhhssss,             & 
& cplAhAhssss,cplhhhhssss,cplHpsssscHp,cplssssssss,kont,res)
...
If ((Include_in_loopss).and.(Include_in_loophh)) Then 
B0m2 = Real(SA_DerB0(p2,Mss2,Mhh2),dp) 
coup1 = cplhhssss
coup2 = Conjg(cplhhssss)
    SumI = coup1*coup2*B0m2 
res = res +1._dp* SumI  
...
mi2 = mi2+mu2
mi2 = mi2+(Lam*v**2)/2._dp
mi2 = mi2+(g2**2*v**2*Cos(TW)**2*RXiZ)/4._dp
mi2 = mi2+(g1*g2*v**2*Cos(TW)*RXiZ*Sin(TW))/2._dp
mi2 = mi2+(g1**2*v**2*RXiZ*Sin(TW)**2)/4._dp
...
& MVZ,MVZ2,MVWp,MVWp2,MHp,MHp2,Mss,Mss2,cplAhAhhh,cplcFdFdAhL,cplcFdFdAhR,               & 
& cplcFeFeAhL,cplcFeFeAhR,cplcFuFuAhL,cplcFuFuAhR,cplcgWpgWpAh,cplcgWCgWCAh,             & 
& cplAhhhVZ,cplAhHpcVWp,cplAhAhAhAh,cplAhAhhhhh,cplAhAhHpcHp,cplAhAhssss,cplAhAhcVWpVWp, & 
& cplAhAhVZVZ,kont,res)
...
If ((Include_in_loopss).and.(Include_in_loopss)) Then 
B0m2 = Real(SA_B0(p2,Mss2,Mss2),dp) 
coup1 = cplhhssss
coup2 = Conjg(cplhhssss)
    SumI = coup1*coup2*B0m2 
res = res +1._dp/2._dp* SumI  
...
If ((Include_in_loopss).and.(Include_in_loopss)) Then 
B0m2 = Real(SA_DerB0(p2,Mss2,Mss2),dp) 
coup1 = cplhhssss
coup2 = Conjg(cplhhssss)
    SumI = coup1*coup2*B0m2 
res = res +1._dp/2._dp* SumI  
