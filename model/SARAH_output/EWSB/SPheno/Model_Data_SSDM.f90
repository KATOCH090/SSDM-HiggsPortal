...
Complex(dp) :: mu21L 
Complex(dp) :: mu22L 
Real(dp) :: mass_uncertainty_Q(13), mass_uncertainty_Yt(13), g_SM_save(62) 
...
& gP1LFd(3,15),gT1LFd(3),BR1LFd(3,15),gP1Lhh(1,49),gT1Lhh,BR1Lhh(1,49)
...
Logical, save :: InputValueforLS =.False. 
Logical, save :: InputValueforLSH =.False. 
...
& g2,g3,LS,LSH,Lam,Yu,Yd,Ye,MS2,mu2,MZsuffix)
