...
& Lam,Yu,Yd,Ye,MS2,mu2,v,CKMout,sinW2_out,Alpha_out,AlphaS_out,realCKM)
...
scale_save = Qin 
Call ParametersToG67(g1input,g2input,g3input,LSinput,LSHinput,Laminput,               & 
& Yuinput,Ydinput,Yeinput,MS2input,mu2input,vinput,g1D)

Call GToParameters67(g1D,g1,g2,g3,LS,LSH,Lam,Yu,Yd,Ye,MS2,mu2,v)
