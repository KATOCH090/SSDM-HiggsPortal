...
& LS,LSH,Lam,Yu,Yd,Ye,MS2,mu2,.False.)
...
& Mss,Mss2,MVWp,MVWp2,MVZ,MVZ2,TW,ZDR,ZER,ZUR,ZDL,ZEL,ZUL,ZW,ZZ,v,g1,g2,g3,              & 
& LS,LSH,Lam,Yu,Yd,Ye,MS2,mu2,kont)
...
& MFe,MFe2,MFu,MFu2,Mhh,Mhh2,MHp,MHp2,Mss,Mss2,MVWp,MVWp2,MVZ,MVZ2,TW,ZDR,               & 
& ZER,ZUR,ZDL,ZEL,ZUL,ZW,ZZ,v,g1,g2,g3,LS,LSH,Lam,Yu,Yd,Ye,MS2,mu2,mGUT)

n_tot =1
mass_uncertainty_Yt(n_tot:n_tot+0) = MHp! difference will be taken later 
n_tot = n_tot + 1 
mass_uncertainty_Yt(n_tot:n_tot+0) = Mss! difference will be taken later 
n_tot = n_tot + 1 
...
& ZUR,ZDL,ZEL,ZUL,ZW,ZZ,v,g1,g2,g3,LS,LSH,Lam,Yu,Yd,Ye,MS2,mu2,mass_uncertainty_Q)
...
& MFe2,MFu,MFu2,Mhh,Mhh2,MHp,MHp2,Mss,Mss2,MVWp,MVWp2,MVZ,MVZ2,TW,ZDR,ZER,               & 
& ZUR,ZDL,ZEL,ZUL,ZW,ZZ,v,g1,g2,g3,LS,LSH,Lam,Yu,Yd,Ye,MS2,mu2,gPFu,gTFu,BRFu,           & 
& gPFe,gTFe,BRFe,gPFd,gTFd,BRFd,gPhh,gThh,BRhh)

End If 
 
 If (CalculateLowEnergy) then 
Call CalculateLowEnergyConstraints(g1,g2,g3,LS,LSH,Lam,Yu,Yd,Ye,MS2,mu2,              & 
& v,Tpar,Spar,Upar,ae,amu,atau,EDMe,EDMmu,EDMtau,dRho,BrBsGamma,ratioBsGamma,            & 
& BrDmunu,ratioDmunu,BrDsmunu,ratioDsmunu,BrDstaunu,ratioDstaunu,BrBmunu,ratioBmunu,     & 
& BrBtaunu,ratioBtaunu,BrKmunu,ratioKmunu,RK,RKSM,muEgamma,tauEgamma,tauMuGamma,         & 
& CRmuEAl,CRmuETi,CRmuESr,CRmuESb,CRmuEAu,CRmuEPb,BRmuTo3e,BRtauTo3e,BRtauTo3mu,         & 
& BRtauToemumu,BRtauTomuee,BRtauToemumu2,BRtauTomuee2,BrZtoMuE,BrZtoTauE,BrZtoTauMu,     & 
...
If (OutputForMO) Then 
Call RunningFermionMasses(MFe,MFe2,MFd,MFd2,MFu,MFu2,v,g1,g2,g3,LS,LSH,               & 
& Lam,Yu,Yd,Ye,MS2,mu2,kont)

End if 
If (TreeLevelUnitarityLimits) Then 
Write(*,*) "Calculating unitarity constraints " 
Call ScatteringEigenvalues(v,g1,g2,g3,LS,LSH,Lam,Yu,Yd,Ye,MS2,mu2,deltaM,kont)
...
& ZUL,ZW,ZZ,v,g1,g2,g3,LS,LSH,Lam,Yu,Yd,Ye,MS2,mu2,deltaM,kont)
...
kont = 0 
Call FirstGuess(MAh,MAh2,MFd,MFd2,MFe,MFe2,MFu,MFu2,Mhh,Mhh2,MHp,MHp2,Mss,            & 
& Mss2,MVWp,MVWp2,MVZ,MVZ2,TW,ZDR,ZER,ZUR,ZDL,ZEL,ZUL,ZW,ZZ,v,g1,g2,g3,LS,               & 
& LSH,Lam,Yu,Yd,Ye,MS2,mu2,kont)
...
& g3,LS,LSH,Lam,Yu,Yd,Ye,MS2,mu2,mGut,kont,WriteOut,n_run)
...
& MS2input,mu2input,mass_Qerror)

Implicit None 
Integer, Intent(inout) :: kont 
Logical, Intent(in) :: WriteOut 
Real(dp), Intent(in) :: delta 
Real(dp) :: mass_in(13), mass_new(13) 
Real(dp), Intent(out) :: mass_Qerror(13) 
Real(dp) :: gD(67), Q, Qsave, Qstep, Qt, g_SM(62), mh_SM 
Integer :: i1, i2, iupdown, ntot 
Real(dp),Intent(in) :: g1input,g2input,g3input,MS2input
...
n_tot = n_tot + 1 
mass_in(n_tot:n_tot+0) = Mssinput
n_tot = n_tot + 1 
...
Call ParametersToG67(g1,g2,g3,LS,LSH,Lam,Yu,Yd,Ye,MS2,mu2,v,gD)

If (iupdown.eq.1) Then 
 tz=Log(Q/Qsave)
 dt=-tz/50._dp
 Call odeint(gD,67,0._dp,tz,0.1_dp*delta,dt,0._dp,rge67,kont)
Else 
 tz=-Log(Q/Qsave)
 dt=tz/50._dp
 Call odeint(gD,67,tz,0._dp,0.1_dp*delta,dt,0._dp,rge67,kont)
End if 
Call GToParameters67(gD,g1,g2,g3,LS,LSH,Lam,Yu,Yd,Ye,MS2,mu2,v)
