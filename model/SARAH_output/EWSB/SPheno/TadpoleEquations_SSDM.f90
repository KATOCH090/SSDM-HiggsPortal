...
Subroutine SolveTadpoleEquations(g1,g2,g3,LS,LSH,Lam,Yu,Yd,Ye,MS2,mu2,v,Tad1Loop)

Implicit None
Real(dp),Intent(inout) :: g1,g2,g3,MS2,v
...
mu2 = -1._dp/2._dp*(Lam*v**2) + Tad1Loop(1)/v
...
Subroutine CalculateTadpoles(g1,g2,g3,LS,LSH,Lam,Yu,Yd,Ye,MS2,mu2,v,Tad1Loop,         & 
& TadpoleValues)
