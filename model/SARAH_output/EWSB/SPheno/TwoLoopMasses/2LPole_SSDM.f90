...
Subroutine CalculatePi2S(p2,v,g1,g2,g3,LS,LSH,Lam,Yu,Yd,Ye,MS2,mu2,kont,              & 
& tad2L,Pi2S,Pi2P)
...
Complex(dp) :: cplAhAhhh,cplhhhhhh,cplhhHpcHp,cplhhssss,cplVGVGVG,cplcFdFdAhL(3,3),cplcFdFdAhR(3,3), & 
...
Complex(dp) :: cplAhAhAhAh,cplAhAhhhhh,cplAhAhHpcHp,cplAhAhssss,cplhhhhhhhh,cplhhhhHpcHp,            & 
...
& MHp2,Mss,Mss2,MVWp,MVWp2,MVZ,MVZ2,TW,ZDR,ZER,ZUR,ZDL,ZEL,ZUL,ZW,ZZ,v,g1,               & 
& g2,g3,LS,LSH,Lam,Yu,Yd,Ye,MS2,mu2,.True.,kont)

If (Abs(MHp2/Qscale).lt.TwoLoopRegulatorMass) MHp2=Qscale*TwoLoopRegulatorMass
If (Abs(Mss2/Qscale).lt.TwoLoopRegulatorMass) Mss2=Qscale*TwoLoopRegulatorMass
...
Call CouplingsFor2LPole3(Lam,v,LSH,g3,Yd,ZDL,ZDR,Ye,ZEL,ZER,Yu,ZUL,ZUR,               & 
& cplAhAhhh,cplhhhhhh,cplhhHpcHp,cplhhssss,cplVGVGVG,cplcFdFdAhL,cplcFdFdAhR,            & 
...
Call CouplingsFor2LPole4(Lam,LSH,LS,cplAhAhAhAh,cplAhAhhhhh,cplAhAhHpcHp,             & 
...
coup1 = cplhhHpcHp
   temptad(gE1) = temptad(gE1)-real(coup1*A0m,dp) 
  End Do 
A0m = 1._dp/2._dp*(-J0(Mss2,qscale)) 
  Do gE1 = 1, 1
coup1 = cplhhssss
   temptad(gE1) = temptad(gE1)-real(coup1*A0m,dp) 
  End Do 
...
! ----------------------------------
tad1LmatrixHp=0._dp
tad1LmatrixHp(1,1)=tad1LmatrixHp(1,1)+1/v*tad1LG(1)
do i1=1,1
do i2=1,1
...
tad1LmatrixAh=0._dp
tad1LmatrixAh(1,1)=tad1LmatrixAh(1,1)+1/v*tad1LG(1)
do i1=1,1
do i2=1,1
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingvector(gE1)= 0._dp
   ...
   End Do
if(nonzerocoupling) then 
 funcvalue= 1._dp/2._dp*TfSSS(Mhh2,Mss2,Mss2,Qscale)
 temptad=temptad+tempcouplingvector*funcvalue
end if
! ---- Topology ToSS
! ---- Ah,Ah,Ah ----
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingvector(gE1)= 0._dp
   ...
   End Do
if(nonzerocoupling) then 
 funcvalue= 1._dp/4._dp*TfSS(MAh2,MAh2,Mss2,Qscale)
 temptad=temptad+tempcouplingvector*funcvalue
end if
! ---- hh,hh,Ah ----
nonzerocoupling=.false.
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingvector(gE1)= 0._dp
   ...
   End Do
if(nonzerocoupling) then 
 funcvalue= 1._dp/4._dp*TfSS(Mhh2,Mhh2,Mss2,Qscale)
 temptad=temptad+tempcouplingvector*funcvalue
end if
! ---- Hp,conj[Hp],Ah ----
nonzerocoupling=.false.
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingvector(gE1)= 0._dp
   ...
   End Do
if(nonzerocoupling) then 
 funcvalue= 1._dp/2._dp*TfSS(MHp2,MHp2,Mss2,Qscale)
 temptad=temptad+tempcouplingvector*funcvalue
end if
! ---- ss,ss,Ah ----
nonzerocoupling=.false.
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingvector(gE1)= 0._dp
   ...
   End Do
if(nonzerocoupling) then 
 funcvalue= 1._dp/4._dp*TfSS(Mss2,Mss2,MAh2,Qscale)
 temptad=temptad+tempcouplingvector*funcvalue
end if
! ---- ss,ss,hh ----
nonzerocoupling=.false.
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingvector(gE1)= 0._dp
   ...
   End Do
if(nonzerocoupling) then 
 funcvalue= 1._dp/4._dp*TfSS(Mss2,Mss2,Mhh2,Qscale)
 temptad=temptad+tempcouplingvector*funcvalue
end if
! ---- ss,ss,Hp ----
nonzerocoupling=.false.
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingvector(gE1)= 0._dp
   ...
   End Do
if(nonzerocoupling) then 
 funcvalue= 1._dp/2._dp*TfSS(Mss2,Mss2,MHp2,Qscale)
 temptad=temptad+tempcouplingvector*funcvalue
end if
! ---- ss,ss,ss ----
nonzerocoupling=.false.
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingvector(gE1)= 0._dp
   ...
   End Do
if(nonzerocoupling) then 
 funcvalue= 1._dp/4._dp*TfSS(Mss2,Mss2,Mss2,Qscale)
 temptad=temptad+tempcouplingvector*funcvalue
end if
! ---- Topology ToSSSS
! ---- Ah,Ah,Ah,hh ----
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingvector(gE1)= 0._dp
   ...
   End Do
if(nonzerocoupling) then 
 funcvalue= -1._dp/4._dp*TfSSSS(Mhh2,Mhh2,Mss2,Mss2,Qscale)
 temptad=temptad+tempcouplingvector*funcvalue
end if
! ---- Hp,conj[Hp],hh,Hp ----
nonzerocoupling=.false.
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingvector(gE1)= 0._dp
   ...
   End Do
if(nonzerocoupling) then 
 funcvalue= -1._dp/2._dp*TfSSSS(Mss2,Mss2,Mhh2,Mss2,Qscale)
 temptad=temptad+tempcouplingvector*funcvalue
end if
! ---- Topology ToSSFF
! ---- Ah,Ah,Fd,bar[Fd] ----
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= -1._dp/4._dp*WfSSSS(p2,Mhh2,Mhh2,Mss2,Mss2,Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
! ---- Hp,conj[Hp],hh,Hp ----
nonzerocoupling=.false.
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= -1._dp/2._dp*WfSSSS(p2,Mss2,Mss2,Mhh2,Mss2,Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
! ---- Topology XoSSS
! ---- Ah,Ah,Ah ----
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= 1._dp/4._dp*XfSSS(p2,MAh2,MAh2,Mss2,Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
! ---- hh,hh,Ah ----
nonzerocoupling=.false.
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= 1._dp/4._dp*XfSSS(p2,Mhh2,Mhh2,Mss2,Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
! ---- Hp,conj[Hp],Ah ----
nonzerocoupling=.false.
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= 1._dp/2._dp*XfSSS(p2,MHp2,MHp2,Mss2,Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
! ---- ss,ss,Ah ----
nonzerocoupling=.false.
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= 1._dp/4._dp*XfSSS(p2,Mss2,Mss2,MAh2,Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
! ---- ss,ss,hh ----
nonzerocoupling=.false.
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= 1._dp/4._dp*XfSSS(p2,Mss2,Mss2,Mhh2,Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
! ---- ss,ss,Hp ----
nonzerocoupling=.false.
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= 1._dp/2._dp*XfSSS(p2,Mss2,Mss2,MHp2,Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
! ---- ss,ss,ss ----
nonzerocoupling=.false.
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= 1._dp/4._dp*XfSSS(p2,Mss2,Mss2,Mss2,Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
! ---- Topology YoSSSS
! ---- Ah,Ah,Ah,Ah ----
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= -1._dp/2._dp*YfSSSS(p2,MAh2,MAh2,MAh2,Mss2,Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
! ---- hh,hh,hh,Ah ----
nonzerocoupling=.false.
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= -1._dp/2._dp*YfSSSS(p2,Mhh2,Mhh2,Mhh2,Mss2,Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
! ---- Hp,conj[Hp],Hp,Ah ----
nonzerocoupling=.false.
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= -1._dp*YfSSSS(p2,MHp2,MHp2,MHp2,Mss2,Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
! ---- ss,ss,ss,Ah ----
nonzerocoupling=.false.
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= -1._dp/2._dp*YfSSSS(p2,Mss2,Mss2,Mss2,MAh2,Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
! ---- ss,ss,ss,hh ----
nonzerocoupling=.false.
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= -1._dp/2._dp*YfSSSS(p2,Mss2,Mss2,Mss2,Mhh2,Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
! ---- ss,ss,ss,Hp ----
nonzerocoupling=.false.
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= -1._dp*YfSSSS(p2,Mss2,Mss2,Mss2,MHp2,Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
! ---- ss,ss,ss,ss ----
nonzerocoupling=.false.
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= -1._dp/2._dp*YfSSSS(p2,Mss2,Mss2,Mss2,Mss2,Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
! ---- Topology ZoSSSS
! ---- Ah,Ah,Ah,Ah ----
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= -1._dp/2._dp*ZfSSSS(p2,MAh2,MAh2,Mss2,Mss2,Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
! ---- hh,hh,hh,hh ----
nonzerocoupling=.false.
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= -1._dp/2._dp*ZfSSSS(p2,Mhh2,Mhh2,Mss2,Mss2,Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= -1._dp*ZfSSSS(p2,MHp2,MHp2,Mss2,Mss2,Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
! ---- ss,ss,ss,ss ----
nonzerocoupling=.false.
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= -1._dp/4._dp*ZfSSSS(p2,Mss2,Mss2,Mss2,Mss2,Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
! ---- Topology SoSSS
! ---- Ah,Ah,hh ----
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= 1._dp/2._dp*SfSSS(p2,Mhh2,Mss2,Mss2,Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
! ---- Topology UoSSSS
! ---- Ah,Ah,Ah,hh ----
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= -1._dp*UfSSSS(p2,Mhh2,Mhh2,Mss2,Mss2,Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
! ---- Hp,conj[Hp],hh,Hp ----
nonzerocoupling=.false.
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= -2._dp*UfSSSS(p2,Mss2,Mss2,Mhh2,Mss2,Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
! ---- Topology VoSSSSS
! ---- Ah,Ah,Ah,Ah,hh ----
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= 1._dp/2._dp*VfSSSSS(p2,Mhh2,Mhh2,Mhh2,Mss2,Mss2,Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= 1._dp*VfSSSSS(p2,Mss2,Mss2,Mss2,Mhh2,Mss2,Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
! ---- Topology MoSSSSS
! ---- Ah,Ah,Ah,Ah,hh ----
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= 1._dp*MfSSSSS(p2,Mhh2,Mss2,Mhh2,Mss2,Mss2,Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrix(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= 1._dp/2._dp*MfSSSSS(p2,Mss2,Mss2,Mss2,Mss2,Mhh2,Qscale)
 tempcont=tempcont+tempcouplingmatrix*funcvalue
end if
! ---- Topology WoSSFF
! ---- Ah,Ah,Fd,bar[Fd] ----
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrixah(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= -1._dp/2._dp*YfSSSS(p2,MAh2,Mhh2,Mhh2,Mss2,Qscale)
 tempcontah=tempcontah+tempcouplingmatrixah*funcvalue
end if
! ---- hh,Ah,Ah,Ah ----
nonzerocoupling=.false.
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrixah(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= -1._dp/2._dp*YfSSSS(p2,Mhh2,MAh2,MAh2,Mss2,Qscale)
 tempcontah=tempcontah+tempcouplingmatrixah*funcvalue
end if
! ---- Topology ZoSSSS
! ---- Ah,hh,Ah,hh ----
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrixah(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= 1._dp/2._dp*SfSSS(p2,MAh2,Mss2,Mss2,Qscale)
 tempcontah=tempcontah+tempcouplingmatrixah*funcvalue
end if
! ---- Topology UoSSSS
! ---- Ah,hh,Ah,Ah ----
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrixah(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= -1._dp*UfSSSS(p2,MAh2,Mhh2,Mss2,Mss2,Qscale)
 tempcontah=tempcontah+tempcouplingmatrixah*funcvalue
end if
! ---- hh,Ah,Ah,hh ----
nonzerocoupling=.false.
...
if(abs(prefactor) .gt. epscouplings) then
 ...
 tempcouplingmatrixah(gE1,gE2)= 0._dp
  ...
  End do
if(nonzerocoupling) then 
 funcvalue= 1._dp/2._dp*VfSSSSS(p2,MAh2,Mhh2,Mhh2,Mss2,Mss2,Qscale)
 tempcontah=tempcontah+tempcouplingmatrixah*funcvalue
end if
! ---- hh,Ah,Ah,Ah,hh ----
nonzerocoupling=.false.
