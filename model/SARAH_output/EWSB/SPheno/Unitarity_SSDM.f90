...
Subroutine ScatteringEigenvalues(vinput,g1input,g2input,g3input,LSinput,              & 
& LSHinput,Laminput,Yuinput,Ydinput,Yeinput,MS2input,mu2input,delta0,kont)

Implicit None 
Integer, Intent(inout) :: kont 
Integer :: ierr 
Real(dp) :: g1,g2,g3,MS2
...
Integer :: iter 
Complex(dp) :: scatter_matrix(15,15) 
Complex(dp) :: rot_matrix(15,15) 
Real(dp) :: eigenvalues_matrix(15), test(2), unitarity_s, scattering_eigenvalue, step_size
Real(dp),Intent(in) :: g1input,g2input,g3input,MS2input,vinput
...
scatter_matrix(1,13) =-1._dp*(Lam)
scatter_matrix(2,14) =-1._dp*(Lam)
scatter_matrix(3,11) =-2._dp*(LSH)
scatter_matrix(4,4) =-2._dp*(Lam)
scatter_matrix(4,9) =-1._dp*(Lam)
scatter_matrix(4,10) =-(sqrt(2._dp)*LSH)
scatter_matrix(5,8) =-1._dp*(Lam)
scatter_matrix(6,15) =-1._dp*(Lam)
scatter_matrix(7,12) =-2._dp*(LSH)
scatter_matrix(8,5) =-1._dp*(Lam)
scatter_matrix(9,4) =-1._dp*(Lam)
scatter_matrix(9,9) =-2._dp*(Lam)
scatter_matrix(9,10) =-(sqrt(2._dp)*LSH)
scatter_matrix(10,4) =-(sqrt(2._dp)*LSH)
scatter_matrix(10,9) =-(sqrt(2._dp)*LSH)
scatter_matrix(10,10) =-6._dp*(LS)
scatter_matrix(11,3) =-2._dp*(LSH)
scatter_matrix(12,7) =-2._dp*(LSH)
scatter_matrix(13,1) =-1._dp*(Lam)
scatter_matrix(14,2) =-1._dp*(Lam)
...
& MHp2input,Mssinput,Mss2input,MVWpinput,MVWp2input,MVZinput,MVZ2input,TWinput,          & 
& ZDRinput,ZERinput,ZURinput,ZDLinput,ZELinput,ZULinput,ZWinput,ZZinput,vinput,          & 
& g1input,g2input,g3input,LSinput,LSHinput,Laminput,Yuinput,Ydinput,Yeinput,             & 
& MS2input,mu2input,delta0,kont)
...
& Mss,Mss2,MVWp,MVWp2,MVZ,MVZ2,TW,ZZ(2,2)
...
& MFu2input(3),Mhhinput,Mhh2input,MHpinput,MHp2input,Mssinput,Mss2input,MVWpinput,       & 
& MVWp2input,MVZinput,MVZ2input,TWinput,ZZinput(2,2)

Complex(dp),Intent(in) :: ZDRinput(3,3),ZERinput(3,3),ZURinput(3,3),ZDLinput(3,3),ZELinput(3,3),ZULinput(3,3),  & 
& ZWinput(2,2)

Complex(dp) :: scatter_matrix1(7,7) 
Complex(dp) :: scatter_matrix1B(7,7) 
Complex(dp) :: rot_matrix1(7,7) 
Real(dp) :: eigenvalues_matrix1(7)
Complex(dp) :: scatter_matrix2(3,3) 
Complex(dp) :: scatter_matrix2B(3,3) 
Complex(dp) :: rot_matrix2(3,3) 
Real(dp) :: eigenvalues_matrix2(3)
...
mu2 = mu2input 
v = vinput 
Call TreeMasses(MAh,MAh2,MFd,MFd2,MFe,MFe2,MFu,MFu2,Mhh,Mhh2,MHp,MHp2,Mss,            & 
& Mss2,MVWp,MVWp2,MVZ,MVZ2,TW,ZDR,ZER,ZUR,ZDL,ZEL,ZUL,ZW,ZZ,v,g1,g2,g3,LS,               & 
& LSH,Lam,Yu,Yd,Ye,MS2,mu2,.True.,kont)

Call CouplingsColourStructures(Lam,v,LSH,LS,cplAhAhhh,cplhhhhhh,cplhhHpcHp,           & 
& cplhhssss,cplAhAhAhAh,cplAhAhhhhh,cplAhAhHpcHp,cplAhAhssss,cplhhhhhhhh,cplhhhhHpcHp,   & 
...
If (IncludeGoldstoneExternal) scatter_matrix1(1,3) = a0_AhAh_Ahss_00(unitarity_s,1,1,1,1,1,3) 
If (IncludeGoldstoneExternal) scatter_matrix1(1,4) = a0_AhAh_hhhh_00(unitarity_s,1,1,1,1,1,4) 
If (IncludeGoldstoneExternal) scatter_matrix1(1,5) = a0_AhAh_hhss_00(unitarity_s,1,1,1,1,1,5) 
If (IncludeGoldstoneExternal) scatter_matrix1(1,6) = a0_AhAh_HpHpc_00(unitarity_s,1,1,1,1,1,6) 
If (IncludeGoldstoneExternal) scatter_matrix1(1,7) = a0_AhAh_ssss_00(unitarity_s,1,1,1,1,1,7) 
...
If (IncludeGoldstoneExternal) scatter_matrix1(2,3) = a0_Ahhh_Ahss_00(unitarity_s,1,1,1,1,2,3) 
If (IncludeGoldstoneExternal) scatter_matrix1(2,4) = a0_Ahhh_hhhh_00(unitarity_s,1,1,1,1,2,4) 
If (IncludeGoldstoneExternal) scatter_matrix1(2,5) = a0_Ahhh_hhss_00(unitarity_s,1,1,1,1,2,5) 
If (IncludeGoldstoneExternal) scatter_matrix1(2,6) = a0_Ahhh_HpHpc_00(unitarity_s,1,1,1,1,2,6) 
If (IncludeGoldstoneExternal) scatter_matrix1(2,7) = a0_Ahhh_ssss_00(unitarity_s,1,1,1,1,2,7) 
If (IncludeGoldstoneExternal) scatter_matrix1(3,1) = a0_Ahss_AhAh_00(unitarity_s,1,1,1,1,3,1) 
If (IncludeGoldstoneExternal) scatter_matrix1(3,2) = a0_Ahss_Ahhh_00(unitarity_s,1,1,1,1,3,2) 
If (IncludeGoldstoneExternal) scatter_matrix1(3,3) = a0_Ahss_Ahss_00(unitarity_s,1,1,1,1,3,3) 
If (IncludeGoldstoneExternal) scatter_matrix1(3,4) = a0_Ahss_hhhh_00(unitarity_s,1,1,1,1,3,4) 
If (IncludeGoldstoneExternal) scatter_matrix1(3,5) = a0_Ahss_hhss_00(unitarity_s,1,1,1,1,3,5) 
If (IncludeGoldstoneExternal) scatter_matrix1(3,6) = a0_Ahss_HpHpc_00(unitarity_s,1,1,1,1,3,6) 
If (IncludeGoldstoneExternal) scatter_matrix1(3,7) = a0_Ahss_ssss_00(unitarity_s,1,1,1,1,3,7) 
scatter_matrix1(4,1) = a0_hhhh_AhAh_00(unitarity_s,1,1,1,1,4,1) 
scatter_matrix1(4,2) = a0_hhhh_Ahhh_00(unitarity_s,1,1,1,1,4,2) 
scatter_matrix1(4,3) = a0_hhhh_Ahss_00(unitarity_s,1,1,1,1,4,3) 
scatter_matrix1(4,4) = a0_hhhh_hhhh_00(unitarity_s,1,1,1,1,4,4) 
scatter_matrix1(4,5) = a0_hhhh_hhss_00(unitarity_s,1,1,1,1,4,5) 
scatter_matrix1(4,6) = a0_hhhh_HpHpc_00(unitarity_s,1,1,1,1,4,6) 
scatter_matrix1(4,7) = a0_hhhh_ssss_00(unitarity_s,1,1,1,1,4,7) 
scatter_matrix1(5,1) = a0_hhss_AhAh_00(unitarity_s,1,1,1,1,5,1) 
scatter_matrix1(5,2) = a0_hhss_Ahhh_00(unitarity_s,1,1,1,1,5,2) 
scatter_matrix1(5,3) = a0_hhss_Ahss_00(unitarity_s,1,1,1,1,5,3) 
scatter_matrix1(5,4) = a0_hhss_hhhh_00(unitarity_s,1,1,1,1,5,4) 
scatter_matrix1(5,5) = a0_hhss_hhss_00(unitarity_s,1,1,1,1,5,5) 
scatter_matrix1(5,6) = a0_hhss_HpHpc_00(unitarity_s,1,1,1,1,5,6) 
scatter_matrix1(5,7) = a0_hhss_ssss_00(unitarity_s,1,1,1,1,5,7) 
If (IncludeGoldstoneExternal) scatter_matrix1(6,1) = a0_HpHpc_AhAh_00(unitarity_s,1,1,1,1,6,1) 
If (IncludeGoldstoneExternal) scatter_matrix1(6,2) = a0_HpHpc_Ahhh_00(unitarity_s,1,1,1,1,6,2) 
If (IncludeGoldstoneExternal) scatter_matrix1(6,3) = a0_HpHpc_Ahss_00(unitarity_s,1,1,1,1,6,3) 
If (IncludeGoldstoneExternal) scatter_matrix1(6,4) = a0_HpHpc_hhhh_00(unitarity_s,1,1,1,1,6,4) 
If (IncludeGoldstoneExternal) scatter_matrix1(6,5) = a0_HpHpc_hhss_00(unitarity_s,1,1,1,1,6,5) 
If (IncludeGoldstoneExternal) scatter_matrix1(6,6) = a0_HpHpc_HpHpc_00(unitarity_s,1,1,1,1,6,6) 
If (IncludeGoldstoneExternal) scatter_matrix1(6,7) = a0_HpHpc_ssss_00(unitarity_s,1,1,1,1,6,7) 
scatter_matrix1(7,1) = a0_ssss_AhAh_00(unitarity_s,1,1,1,1,7,1) 
scatter_matrix1(7,2) = a0_ssss_Ahhh_00(unitarity_s,1,1,1,1,7,2) 
scatter_matrix1(7,3) = a0_ssss_Ahss_00(unitarity_s,1,1,1,1,7,3) 
scatter_matrix1(7,4) = a0_ssss_hhhh_00(unitarity_s,1,1,1,1,7,4) 
scatter_matrix1(7,5) = a0_ssss_hhss_00(unitarity_s,1,1,1,1,7,5) 
scatter_matrix1(7,6) = a0_ssss_HpHpc_00(unitarity_s,1,1,1,1,7,6) 
scatter_matrix1(7,7) = a0_ssss_ssss_00(unitarity_s,1,1,1,1,7,7) 
...
If (IncludeGoldstoneExternal) scatter_matrix2(1,3) = a0_AhHp_ssHpc_00(unitarity_s,1,1,1,1,1,3) 
...
If (IncludeGoldstoneExternal) scatter_matrix2(2,3) = a0_hhHp_ssHpc_00(unitarity_s,1,1,1,1,2,3) 
If (IncludeGoldstoneExternal) scatter_matrix2(3,1) = a0_Hpss_AhHpc_00(unitarity_s,1,1,1,1,3,1) 
If (IncludeGoldstoneExternal) scatter_matrix2(3,2) = a0_Hpss_hhHpc_00(unitarity_s,1,1,1,1,3,2) 
If (IncludeGoldstoneExternal) scatter_matrix2(3,3) = a0_Hpss_ssHpc_00(unitarity_s,1,1,1,1,3,3) 
...
Complex(dp) Function a0_AhAh_Ahss_00(s,i1,i2,i3,i4,ind1,ind2)  Result(amp)
Implicit None 
Integer, Intent(in) :: i1,i2,i3,i4,ind1,ind2 
Real(dp), Intent(in) :: s 
Integer :: iprop, istart,c1,c2,c2end 
...
Complex(dp) Function a0_AhAh_hhss_00(s,i1,i2,i3,i4,ind1,ind2)  Result(amp)
Implicit None 
Integer, Intent(in) :: i1,i2,i3,i4,ind1,ind2 
Real(dp), Intent(in) :: s 
Integer :: iprop, istart,c1,c2,c2end 
...
Complex(dp) Function a0_AhAh_ssss_00(s,i1,i2,i3,i4,ind1,ind2)  Result(amp)
Implicit None 
Integer, Intent(in) :: i1,i2,i3,i4,ind1,ind2 
Real(dp), Intent(in) :: s 
Integer :: iprop, istart,c1,c2,c2end 
...
Complex(dp) Function a0_Ahhh_Ahss_00(s,i1,i2,i3,i4,ind1,ind2)  Result(amp)
Implicit None 
Integer, Intent(in) :: i1,i2,i3,i4,ind1,ind2 
Real(dp), Intent(in) :: s 
Integer :: iprop, istart,c1,c2,c2end 
...
Complex(dp) Function a0_Ahhh_hhss_00(s,i1,i2,i3,i4,ind1,ind2)  Result(amp)
Implicit None 
Integer, Intent(in) :: i1,i2,i3,i4,ind1,ind2 
Real(dp), Intent(in) :: s 
Integer :: iprop, istart,c1,c2,c2end 
...
Complex(dp) Function a0_Ahhh_ssss_00(s,i1,i2,i3,i4,ind1,ind2)  Result(amp)
Implicit None 
Integer, Intent(in) :: i1,i2,i3,i4,ind1,ind2 
Real(dp), Intent(in) :: s 
Integer :: iprop, istart,c1,c2,c2end 
...
Complex(dp) Function a0_AhHp_ssHpc_00(s,i1,i2,i3,i4,ind1,ind2)  Result(amp)
Implicit None 
Integer, Intent(in) :: i1,i2,i3,i4,ind1,ind2 
Real(dp), Intent(in) :: s 
Integer :: iprop, istart,c1,c2,c2end 
...
If (TUcutLevel.eq.1) Then 
 amp_poles = 0.5_dp*oo16pi*amp_poles*sqrt(sqrt(Kaehler(s,m1**2,m2**2)*Kaehler(s,m3**2,m4**2)))/s 
  ...
  End if 
End if 
End Function a0_AhHp_ssHpc_00

Complex(dp) Function a0_Ahss_AhAh_00(s,i1,i2,i3,i4,ind1,ind2)  Result(amp)
Implicit None 
Integer, Intent(in) :: i1,i2,i3,i4,ind1,ind2 
Real(dp), Intent(in) :: s 
Integer :: iprop, istart,c1,c2,c2end 
...
If (i3.eq.i4) amp_poles=amp_poles/sqrt(2._dp) 
  ...
  End if 
End if 
End Function a0_Ahss_AhAh_00

Complex(dp) Function a0_Ahss_Ahhh_00(s,i1,i2,i3,i4,ind1,ind2)  Result(amp)
Implicit None 
Integer, Intent(in) :: i1,i2,i3,i4,ind1,ind2 
Real(dp), Intent(in) :: s 
Integer :: iprop, istart,c1,c2,c2end 
...
If (TUcutLevel.eq.1) Then 
 amp_poles = 0.5_dp*oo16pi*amp_poles*sqrt(sqrt(Kaehler(s,m1**2,m2**2)*Kaehler(s,m3**2,m4**2)))/s 
  ...
  End if 
End if 
End Function a0_Ahss_Ahhh_00

Complex(dp) Function a0_Ahss_Ahss_00(s,i1,i2,i3,i4,ind1,ind2)  Result(amp)
Implicit None 
Integer, Intent(in) :: i1,i2,i3,i4,ind1,ind2 
Real(dp), Intent(in) :: s 
Integer :: iprop, istart,c1,c2,c2end 
...
If (TUcutLevel.eq.1) Then 
 amp_poles = 0.5_dp*oo16pi*amp_poles*sqrt(sqrt(Kaehler(s,m1**2,m2**2)*Kaehler(s,m3**2,m4**2)))/s 
  ...
  End if 
End if 
End Function a0_Ahss_Ahss_00

Complex(dp) Function a0_Ahss_hhhh_00(s,i1,i2,i3,i4,ind1,ind2)  Result(amp)
Implicit None 
Integer, Intent(in) :: i1,i2,i3,i4,ind1,ind2 
Real(dp), Intent(in) :: s 
Integer :: iprop, istart,c1,c2,c2end 
...
If (i3.eq.i4) amp_poles=amp_poles/sqrt(2._dp) 
  ...
  End if 
End if 
End Function a0_Ahss_hhhh_00

Complex(dp) Function a0_Ahss_hhss_00(s,i1,i2,i3,i4,ind1,ind2)  Result(amp)
Implicit None 
Integer, Intent(in) :: i1,i2,i3,i4,ind1,ind2 
Real(dp), Intent(in) :: s 
Integer :: iprop, istart,c1,c2,c2end 
...
If (TUcutLevel.eq.1) Then 
 amp_poles = 0.5_dp*oo16pi*amp_poles*sqrt(sqrt(Kaehler(s,m1**2,m2**2)*Kaehler(s,m3**2,m4**2)))/s 
  ...
  End if 
End if 
End Function a0_Ahss_hhss_00

Complex(dp) Function a0_Ahss_HpHpc_00(s,i1,i2,i3,i4,ind1,ind2)  Result(amp)
Implicit None 
Integer, Intent(in) :: i1,i2,i3,i4,ind1,ind2 
Real(dp), Intent(in) :: s 
Integer :: iprop, istart,c1,c2,c2end 
...
If (TUcutLevel.eq.1) Then 
 amp_poles = 0.5_dp*oo16pi*amp_poles*sqrt(sqrt(Kaehler(s,m1**2,m2**2)*Kaehler(s,m3**2,m4**2)))/s 
  ...
  End if 
End if 
End Function a0_Ahss_HpHpc_00

Complex(dp) Function a0_Ahss_ssss_00(s,i1,i2,i3,i4,ind1,ind2)  Result(amp)
Implicit None 
Integer, Intent(in) :: i1,i2,i3,i4,ind1,ind2 
Real(dp), Intent(in) :: s 
Integer :: iprop, istart,c1,c2,c2end 
...
Complex(dp) Function a0_AhHpc_Hpss_00(s,i1,i2,i3,i4,ind1,ind2)  Result(amp)
Implicit None 
Integer, Intent(in) :: i1,i2,i3,i4,ind1,ind2 
Real(dp), Intent(in) :: s 
Integer :: iprop, istart,c1,c2,c2end 
...
Complex(dp) Function a0_hhhh_Ahss_00(s,i1,i2,i3,i4,ind1,ind2)  Result(amp)
Implicit None 
Integer, Intent(in) :: i1,i2,i3,i4,ind1,ind2 
Real(dp), Intent(in) :: s 
Integer :: iprop, istart,c1,c2,c2end 
...
Complex(dp) Function a0_hhhh_hhss_00(s,i1,i2,i3,i4,ind1,ind2)  Result(amp)
Implicit None 
Integer, Intent(in) :: i1,i2,i3,i4,ind1,ind2 
Real(dp), Intent(in) :: s 
Integer :: iprop, istart,c1,c2,c2end 
...
Complex(dp) Function a0_hhhh_ssss_00(s,i1,i2,i3,i4,ind1,ind2)  Result(amp)
Implicit None 
Integer, Intent(in) :: i1,i2,i3,i4,ind1,ind2 
Real(dp), Intent(in) :: s 
Integer :: iprop, istart,c1,c2,c2end 
...
unicpl1(1)=cplhhssss
unicpl2(1)=cplhhssss
tempamp2(1,1)= unicpl1(1)*unicpl2(1)*Tchannel(m1,m2,m3,m4,Mss,s,(1._dp,0._dp),(1._dp,0._dp)) 
If  (((s.lt.(CheckTpole(m1**2,m2**2,m3**2,m4**2,Mss**2)))).and.(maxval(Abs(tempamp2)).gt.1.0E-10_dp)) Then 
! Write(*,*) "T",m1,m2,m3,m4,Mss  
Select Case (TUcutLevel) 
 Case (4) 
   Any_Pole_Present = .True. 
 Case (3) 
...
unicpl1(1)=cplhhssss
unicpl2(1)=cplhhssss
tempamp2(1,1)= unicpl1(1)*unicpl2(1)*Uchannel(m1,m2,m3,m4,Mss,s,(1._dp,0._dp),(1._dp,0._dp)) 
If  (((s.lt.(CheckUpole(m1**2,m2**2,m3**2,m4**2,Mss**2)))).and.(maxval(Abs(tempamp2)).gt.1.0E-10_dp)) Then 
! Write(*,*) "U",m1,m2,m3,m4,Mss  
Select Case (TUcutLevel) 
 Case (4) 
   Any_Pole_Present = .True. 
 Case (3) 
...
Complex(dp) Function a0_hhHp_ssHpc_00(s,i1,i2,i3,i4,ind1,ind2)  Result(amp)
Implicit None 
Integer, Intent(in) :: i1,i2,i3,i4,ind1,ind2 
Real(dp), Intent(in) :: s 
Integer :: iprop, istart,c1,c2,c2end 
...
If (TUcutLevel.eq.1) Then 
 amp_poles = 0.5_dp*oo16pi*amp_poles*sqrt(sqrt(Kaehler(s,m1**2,m2**2)*Kaehler(s,m3**2,m4**2)))/s 
  ...
  End if 
End if 
End Function a0_hhHp_ssHpc_00

Complex(dp) Function a0_hhss_AhAh_00(s,i1,i2,i3,i4,ind1,ind2)  Result(amp)
Implicit None 
Integer, Intent(in) :: i1,i2,i3,i4,ind1,ind2 
Real(dp), Intent(in) :: s 
Integer :: iprop, istart,c1,c2,c2end 
...
If (i3.eq.i4) amp_poles=amp_poles/sqrt(2._dp) 
  ...
  End if 
End if 
End Function a0_hhss_AhAh_00

Complex(dp) Function a0_hhss_Ahhh_00(s,i1,i2,i3,i4,ind1,ind2)  Result(amp)
Implicit None 
Integer, Intent(in) :: i1,i2,i3,i4,ind1,ind2 
Real(dp), Intent(in) :: s 
Integer :: iprop, istart,c1,c2,c2end 
...
If (TUcutLevel.eq.1) Then 
 amp_poles = 0.5_dp*oo16pi*amp_poles*sqrt(sqrt(Kaehler(s,m1**2,m2**2)*Kaehler(s,m3**2,m4**2)))/s 
  ...
  End if 
End if 
End Function a0_hhss_Ahhh_00

Complex(dp) Function a0_hhss_Ahss_00(s,i1,i2,i3,i4,ind1,ind2)  Result(amp)
Implicit None 
Integer, Intent(in) :: i1,i2,i3,i4,ind1,ind2 
Real(dp), Intent(in) :: s 
Integer :: iprop, istart,c1,c2,c2end 
...
If (TUcutLevel.eq.1) Then 
 amp_poles = 0.5_dp*oo16pi*amp_poles*sqrt(sqrt(Kaehler(s,m1**2,m2**2)*Kaehler(s,m3**2,m4**2)))/s 
  ...
  End if 
End if 
End Function a0_hhss_Ahss_00

Complex(dp) Function a0_hhss_hhhh_00(s,i1,i2,i3,i4,ind1,ind2)  Result(amp)
Implicit None 
Integer, Intent(in) :: i1,i2,i3,i4,ind1,ind2 
Real(dp), Intent(in) :: s 
Integer :: iprop, istart,c1,c2,c2end 
...
If (i3.eq.i4) amp_poles=amp_poles/sqrt(2._dp) 
  ...
  End if 
End if 
End Function a0_hhss_hhhh_00

Complex(dp) Function a0_hhss_hhss_00(s,i1,i2,i3,i4,ind1,ind2)  Result(amp)
Implicit None 
Integer, Intent(in) :: i1,i2,i3,i4,ind1,ind2 
Real(dp), Intent(in) :: s 
Integer :: iprop, istart,c1,c2,c2end 
...
unicpl1(1)=cplhhssss
unicpl2(1)=cplhhssss
tempamp2(1,1)= unicpl1(1)*unicpl2(1)*Schannel(m1,m2,m3,m4,Mss,s,(1._dp,0._dp),(1._dp,0._dp)) 
If (Abs(1-s/Mss**2).lt.CutSpole) Then 
 Any_Pole_Present = .true. 
 Pole_Present = .true. 
Else 
  amp = amp + tempamp2(1,1)
...
If (TUcutLevel.eq.1) Then 
 amp_poles = 0.5_dp*oo16pi*amp_poles*sqrt(sqrt(Kaehler(s,m1**2,m2**2)*Kaehler(s,m3**2,m4**2)))/s 
  ...
  End if 
End if 
End Function a0_hhss_hhss_00

Complex(dp) Function a0_hhss_HpHpc_00(s,i1,i2,i3,i4,ind1,ind2)  Result(amp)
Implicit None 
Integer, Intent(in) :: i1,i2,i3,i4,ind1,ind2 
Real(dp), Intent(in) :: s 
Integer :: iprop, istart,c1,c2,c2end 
...
If (TUcutLevel.eq.1) Then 
 amp_poles = 0.5_dp*oo16pi*amp_poles*sqrt(sqrt(Kaehler(s,m1**2,m2**2)*Kaehler(s,m3**2,m4**2)))/s 
  ...
  End if 
End if 
End Function a0_hhss_HpHpc_00

Complex(dp) Function a0_hhss_ssss_00(s,i1,i2,i3,i4,ind1,ind2)  Result(amp)
Implicit None 
Integer, Intent(in) :: i1,i2,i3,i4,ind1,ind2 
Real(dp), Intent(in) :: s 
Integer :: iprop, istart,c1,c2,c2end 
...
Complex(dp) Function a0_hhHpc_Hpss_00(s,i1,i2,i3,i4,ind1,ind2)  Result(amp)
Implicit None 
Integer, Intent(in) :: i1,i2,i3,i4,ind1,ind2 
Real(dp), Intent(in) :: s 
Integer :: iprop, istart,c1,c2,c2end 
...
Complex(dp) Function a0_Hpss_AhHpc_00(s,i1,i2,i3,i4,ind1,ind2)  Result(amp)
Implicit None 
Integer, Intent(in) :: i1,i2,i3,i4,ind1,ind2 
Real(dp), Intent(in) :: s 
Integer :: iprop, istart,c1,c2,c2end 
...
If (TUcutLevel.eq.1) Then 
 amp_poles = 0.5_dp*oo16pi*amp_poles*sqrt(sqrt(Kaehler(s,m1**2,m2**2)*Kaehler(s,m3**2,m4**2)))/s 
  ...
  End if 
End if 
End Function a0_Hpss_AhHpc_00

Complex(dp) Function a0_Hpss_hhHpc_00(s,i1,i2,i3,i4,ind1,ind2)  Result(amp)
Implicit None 
Integer, Intent(in) :: i1,i2,i3,i4,ind1,ind2 
Real(dp), Intent(in) :: s 
Integer :: iprop, istart,c1,c2,c2end 
...
If (TUcutLevel.eq.1) Then 
 amp_poles = 0.5_dp*oo16pi*amp_poles*sqrt(sqrt(Kaehler(s,m1**2,m2**2)*Kaehler(s,m3**2,m4**2)))/s 
  ...
  End if 
End if 
End Function a0_Hpss_hhHpc_00

Complex(dp) Function a0_Hpss_ssHpc_00(s,i1,i2,i3,i4,ind1,ind2)  Result(amp)
Implicit None 
Integer, Intent(in) :: i1,i2,i3,i4,ind1,ind2 
Real(dp), Intent(in) :: s 
Integer :: iprop, istart,c1,c2,c2end 
...
Complex(dp) Function a0_HpHpc_Ahss_00(s,i1,i2,i3,i4,ind1,ind2)  Result(amp)
Implicit None 
Integer, Intent(in) :: i1,i2,i3,i4,ind1,ind2 
Real(dp), Intent(in) :: s 
Integer :: iprop, istart,c1,c2,c2end 
...
Complex(dp) Function a0_HpHpc_hhss_00(s,i1,i2,i3,i4,ind1,ind2)  Result(amp)
Implicit None 
Integer, Intent(in) :: i1,i2,i3,i4,ind1,ind2 
Real(dp), Intent(in) :: s 
Integer :: iprop, istart,c1,c2,c2end 
...
Complex(dp) Function a0_HpHpc_ssss_00(s,i1,i2,i3,i4,ind1,ind2)  Result(amp)
Implicit None 
Integer, Intent(in) :: i1,i2,i3,i4,ind1,ind2 
Real(dp), Intent(in) :: s 
Integer :: iprop, istart,c1,c2,c2end 
...
If (i3.eq.i4) amp_poles=amp_poles/sqrt(2._dp) 
  ...
  End if 
End if 
End Function a0_HpHpc_ssss_00

Complex(dp) Function a0_ssss_AhAh_00(s,i1,i2,i3,i4,ind1,ind2)  Result(amp)
Implicit None 
Integer, Intent(in) :: i1,i2,i3,i4,ind1,ind2 
Real(dp), Intent(in) :: s 
Integer :: iprop, istart,c1,c2,c2end 
...
If (i3.eq.i4) amp_poles=amp_poles/sqrt(2._dp) 
  ...
  End if 
End if 
End Function a0_ssss_AhAh_00

Complex(dp) Function a0_ssss_Ahhh_00(s,i1,i2,i3,i4,ind1,ind2)  Result(amp)
Implicit None 
Integer, Intent(in) :: i1,i2,i3,i4,ind1,ind2 
Real(dp), Intent(in) :: s 
Integer :: iprop, istart,c1,c2,c2end 
...
If (i1.eq.i2) amp_poles=amp_poles/sqrt(2._dp) 
  ...
  End if 
End if 
End Function a0_ssss_Ahhh_00

Complex(dp) Function a0_ssss_Ahss_00(s,i1,i2,i3,i4,ind1,ind2)  Result(amp)
Implicit None 
Integer, Intent(in) :: i1,i2,i3,i4,ind1,ind2 
Real(dp), Intent(in) :: s 
Integer :: iprop, istart,c1,c2,c2end 
...
If (i1.eq.i2) amp_poles=amp_poles/sqrt(2._dp) 
  ...
  End if 
End if 
End Function a0_ssss_Ahss_00

Complex(dp) Function a0_ssss_hhhh_00(s,i1,i2,i3,i4,ind1,ind2)  Result(amp)
Implicit None 
Integer, Intent(in) :: i1,i2,i3,i4,ind1,ind2 
Real(dp), Intent(in) :: s 
Integer :: iprop, istart,c1,c2,c2end 
...
If (i3.eq.i4) amp_poles=amp_poles/sqrt(2._dp) 
  ...
  End if 
End if 
End Function a0_ssss_hhhh_00

Complex(dp) Function a0_ssss_hhss_00(s,i1,i2,i3,i4,ind1,ind2)  Result(amp)
Implicit None 
Integer, Intent(in) :: i1,i2,i3,i4,ind1,ind2 
Real(dp), Intent(in) :: s 
Integer :: iprop, istart,c1,c2,c2end 
...
If (i1.eq.i2) amp_poles=amp_poles/sqrt(2._dp) 
  ...
  End if 
End if 
End Function a0_ssss_hhss_00

Complex(dp) Function a0_ssss_HpHpc_00(s,i1,i2,i3,i4,ind1,ind2)  Result(amp)
Implicit None 
Integer, Intent(in) :: i1,i2,i3,i4,ind1,ind2 
Real(dp), Intent(in) :: s 
Integer :: iprop, istart,c1,c2,c2end 
...
If (i1.eq.i2) amp_poles=amp_poles/sqrt(2._dp) 
  ...
  End if 
End if 
End Function a0_ssss_HpHpc_00

Complex(dp) Function a0_ssss_ssss_00(s,i1,i2,i3,i4,ind1,ind2)  Result(amp)
Implicit None 
Integer, Intent(in) :: i1,i2,i3,i4,ind1,ind2 
Real(dp), Intent(in) :: s 
Integer :: iprop, istart,c1,c2,c2end 
...
If (i3.eq.i4) amp_poles=amp_poles/sqrt(2._dp) 
  ...
  End if 
End if 
End Function a0_ssss_ssss_00

Complex(dp) Function a0_ssHpc_AhHp_00(s,i1,i2,i3,i4,ind1,ind2)  Result(amp)
Implicit None 
Integer, Intent(in) :: i1,i2,i3,i4,ind1,ind2 
Real(dp), Intent(in) :: s 
Integer :: iprop, istart,c1,c2,c2end 
...
If (TUcutLevel.eq.1) Then 
 amp_poles = 0.5_dp*oo16pi*amp_poles*sqrt(sqrt(Kaehler(s,m1**2,m2**2)*Kaehler(s,m3**2,m4**2)))/s 
  ...
  End if 
End if 
End Function a0_ssHpc_AhHp_00

Complex(dp) Function a0_ssHpc_hhHp_00(s,i1,i2,i3,i4,ind1,ind2)  Result(amp)
Implicit None 
Integer, Intent(in) :: i1,i2,i3,i4,ind1,ind2 
Real(dp), Intent(in) :: s 
Integer :: iprop, istart,c1,c2,c2end 
...
If (TUcutLevel.eq.1) Then 
 amp_poles = 0.5_dp*oo16pi*amp_poles*sqrt(sqrt(Kaehler(s,m1**2,m2**2)*Kaehler(s,m3**2,m4**2)))/s 
  ...
  End if 
End if 
End Function a0_ssHpc_hhHp_00

Complex(dp) Function a0_ssHpc_Hpss_00(s,i1,i2,i3,i4,ind1,ind2)  Result(amp)
Implicit None 
Integer, Intent(in) :: i1,i2,i3,i4,ind1,ind2 
Real(dp), Intent(in) :: s 
Integer :: iprop, istart,c1,c2,c2end 
